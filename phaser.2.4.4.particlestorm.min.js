...
(function () {
    ...
    return b.game = null, b.WEBGL_RENDERER = 0, b.CANVAS_RENDERER = 1, b.VERSION = "v2.2.9", b._UID = 0, "undefined" != typeof Float32Array ? (b.Float32Array = Float32Array, b.Uint16Array = Uint16Array, b.Uint32Array = Uint32Array, b.ArrayBuffer = ArrayBuffer) : (b.Float32Array = Array, b.Uint16Array = Array), b.PI_2 = 2 * Math.PI, b.RAD_TO_DEG = 180 / Math.PI, b.DEG_TO_RAD = Math.PI / 180, b.RETINA_PREFIX = "@2x", b.DisplayObject = function () {
        ...
        if (this.visible !== !1 && 0 !== this.alpha) {
            if (a.fd.on && a.fd.cdcs(), this._cacheAsBitmap)return void this._renderCachedSprite(a);
            this._mask && a.maskManager.pushMask(this._mask, a);
            for (var b = 0; b < this.children.length; b++)this.children[b]._renderCanvas(a);
            this._mask && a.maskManager.popMask(a), a.fd.on && a.fd.cdcp()
        }
    }, b.Sprite = function (a) {
        b.DisplayObjectContainer.call(this), this.anchor = new b.Point, this.texture = a || b.Texture.emptyTexture, this._width = 0, this._height = 0, this.tint = 16777215, this.cachedTint = -1, this.tintedTexture = null, this.blendMode = b.blendModes.NORMAL, this.shader = null, this.texture.baseTexture.hasLoaded && this.onTextureUpdate(), this.renderable = !0
        ...
        var b = this.texture.frame.width, c = this.texture.frame.height, d = b * (1 - this.anchor.x),
            e = b * -this.anchor.x, f = c * (1 - this.anchor.y), g = c * -this.anchor.y, h = a || this.worldTransform,
            i = h.a, j = h.b, k = h.c, l = h.d, m = h.tx, n = h.ty, o = -(1 / 0), p = -(1 / 0), q = 1 / 0, r = 1 / 0;
        ...
        if (!(!this.visible || 0 === this.alpha || !this.renderable || this.texture.crop.width <= 0 || this.texture.crop.height <= 0)) {
            ...
            if (c && (d = c), this.blendMode !== a.currentBlendMode && (a.currentBlendMode = this.blendMode, a.context.globalCompositeOperation = b.blendModesCanvas[a.currentBlendMode], a.fd.on && a.fd.cb(this.blendMode)), this._mask && a.maskManager.pushMask(this._mask, a), this.texture.valid) {
                ...
                a.roundPixels ? (a.context.setTransform(d.a, d.b, d.c, d.d, d.tx * a.resolution | 0, d.ty * a.resolution | 0), f |= 0, g |= 0) : a.context.setTransform(d.a, d.b, d.c, d.d, d.tx * a.resolution, d.ty * a.resolution);
                var h = this.texture.crop.width, i = this.texture.crop.height;
                if (f /= e, g /= e, 16777215 !== this.tint) (this.texture.requiresReTint || this.cachedTint !== this.tint) && (this.tintedTexture = b.CanvasTinter.getTintedTexture(this, this.tint), this.cachedTint = this.tint), a.context.drawImage(this.tintedTexture, 0, 0, h, i, f, g, h / e, i / e); else {
                    var j = this.texture.crop.x, k = this.texture.crop.y;
                    a.context.drawImage(this.texture.baseTexture.source, j, k, h, i, f, g, h / e, i / e)
                }
                a.fd.on && a.fd.cs(this.texture, h, i, e)
            }
        ...
        if (this.visible && !(this.alpha <= 0) && this.children.length) {
            ...
            var c = this.worldTransform, d = !0;
            a.fd.on && a.fd.csbs();
            for (var e = 0; e < this.children.length; e++) {
                var f = this.children[e];
                if (f.visible) {
                    var g = f.texture, h = g.frame;
                    if (b.globalAlpha = this.worldAlpha * f.alpha, f.rotation % (2 * Math.PI) === 0) d && (b.setTransform(c.a, c.b, c.c, c.d, c.tx, c.ty), d = !1), b.drawImage(g.baseTexture.source, h.x, h.y, h.width, h.height, f.anchor.x * (-h.width * f.scale.x) + f.position.x + .5 | 0, f.anchor.y * (-h.height * f.scale.y) + f.position.y + .5 | 0, h.width * f.scale.x, h.height * f.scale.y), a.fd.on && a.fd.csb1(g, h.width, h.height, g.baseTexture.resolution); else {
                        d || (d = !0), f.displayObjectUpdateTransform();
                        var i = f.worldTransform;
                        a.roundPixels ? b.setTransform(i.a, i.b, i.c, i.d, 0 | i.tx, 0 | i.ty) : b.setTransform(i.a, i.b, i.c, i.d, i.tx, i.ty), b.drawImage(g.baseTexture.source, h.x, h.y, h.width, h.height, f.anchor.x * -h.width + .5 | 0, f.anchor.y * -h.height + .5 | 0, h.width, h.height), a.fd.on && a.fd.csb2(g, h.width, h.height, g.baseTexture.resolution)
                    }
                }
            }
            a.fd.on && a.fd.csbp()
        ...
        var a = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAQAAAABAQMAAADD8p2OAAAAA1BMVEX/",
            c = "AAAACklEQVQI12NgAAAAAgAB4iG8MwAAAABJRU5ErkJggg==", d = new Image;
        d.src = a + "AP804Oa6" + c;
        var e = new Image;
        e.src = a + "/wCKxvRF" + c;
        ...
        }, this.projection = new b.Point, this.offset = new b.Point, this.shaderManager = new b.WebGLShaderManager, this.spriteBatch = new b.WebGLSpriteBatch, this.maskManager = new b.WebGLMaskManager, this.filterManager = new b.WebGLFilterManager,
            this.stencilManager = new b.WebGLStencilManager, this.blendModeManager = new b.WebGLBlendModeManager, this.renderSession = {}, this.renderSession.game = this.game, this.renderSession.gl = this.gl, this.renderSession.drawCount = 0, this.renderSession.shaderManager = this.shaderManager, this.renderSession.maskManager = this.maskManager, this.renderSession.filterManager = this.filterManager, this.renderSession.blendModeManager = this.blendModeManager, this.renderSession.spriteBatch = this.spriteBatch, this.renderSession.stencilManager = this.stencilManager, this.renderSession.renderer = this, this.renderSession.resolution = this.resolution, this.initContext(), this.mapBlendModes()
        ...
        if (!this.contextLost) {
            a.updateTransform();
            var b = this.gl;
            b.viewport(0, 0, this.width, this.height), b.bindFramebuffer(b.FRAMEBUFFER, null), this.game.clearBeforeRender && (b.clearColor(a._bgColor.r, a._bgColor.g, a._bgColor.b, a._bgColor.a), b.clear(b.COLOR_BUFFER_BIT)), this.game.fd.on && this.game.fd.record(), this.renderDisplayObject(a, this.projection)
        }
        ...
        if (e) {
            ...
            var m = 4 * this.currentBatchSize * this.vertSize, n = c.baseTexture.resolution, o = d.a / n, p = d.b / n,
                q = d.c / n, r = d.d / n, s = d.tx, t = d.ty, u = this.colors, v = this.positions;
        ...
        var g = a.tilePosition.x / (e * a.tileScaleOffset.x), h = a.tilePosition.y / (f * a.tileScaleOffset.y),
        ...
        var k = a.tint, l = (k >> 16) + (65280 & k) + ((255 & k) << 16) + (255 * a.worldAlpha << 24),
            m = this.positions, n = this.colors, o = a.width, p = a.height, q = a.anchor.x, r = a.anchor.y,
            s = o * (1 - q), t = o * -q, u = p * (1 - r), v = p * -r, w = 4 * this.currentBatchSize * this.vertSize,
            x = c.baseTexture.resolution, y = a.worldTransform, z = y.a / x, A = y.b / x, B = y.c / x, C = y.d / x,
            D = y.tx, E = y.ty;
        ...
        if (0 !== this.currentBatchSize) {
            ...
            for (var f, g, h, i, j = 0, k = 0, l = null, m = this.renderSession.blendModeManager.currentBlendMode, n = null, o = !1, p = !1, q = 0, r = this.currentBatchSize; r > q; q++) {
                if (i = this.sprites[q], f = i.tilingTexture ? i.tilingTexture.baseTexture : i.texture.baseTexture, g = i.blendMode, h = i.shader || this.defaultShader, o = m !== g, p = n !== h, (l !== f || o || p) && (this.renderBatch(l, j, k), k = q, j = 0, l = f, o && (m = g, this.renderSession.blendModeManager.setBlendMode(m)), p)) {
        ...
        a.context.restore(), a.fd.on && a.fd.cmo()
        ...
        this.imageUrl ? (delete b.BaseTextureCache[this.imageUrl], delete b.TextureCache[this.imageUrl], this.imageUrl = null, navigator.isCocoonJS || (this.source.src = "")) : this.source && this.source._pixiId && (b.CanvasPool.removeByCanvas(this.source), delete b.BaseTextureCache[this.source._pixiId]), this.source = null, this.unloadFromGPU()
        ...
        a._pixiId || (a._pixiId = "canvas_" + b.TextureCacheIdGenerator++), 0 === a.width && (a.width = 1), 0 === a.height && (a.height = 1);
    ...
    window.console || (window.console = {}, window.console.log = window.console.assert = function () {
        ...
        setTo: function (a, b, c, d) {
            ...
            var c = Math.round(this.start.x), d = Math.round(this.start.y), e = Math.round(this.end.x),
                f = Math.round(this.end.y), g = Math.abs(e - c), h = Math.abs(f - d), i = e > c ? 1 : -1,
                j = f > d ? 1 : -1, k = g - h;
            b.push([c, d]);
            for (var l = 1; c != e || d != f;) {
                var m = k << 1;
        ...
        a = a || 1, b = b || 0, d = d || 0, e = e || 1, f = f || 0, g = g || 0, this.a = a, this.b = b, this.c = d, this.d = e, this.tx = f, this.ty = g, this.type = c.MATRIX
    }, c.Matrix.prototype = {
        ...
        return void 0 === b && (b = !1), a.parent !== this && (this.addChild(a), a.z = this.children.length, this.enableBody && null === a.body ? this.game.physics.enable(a, this.physicsBodyType) : a.body && this.addToHash(a), !b && a.events && a.events.onAddedToGroup$dispatch(a, this), null === this.cursor && (this.cursor = a)), a
        ...
        return void 0 === c && (c = !1), a.parent !== this && (this.addChildAt(a, b), this.updateZ(), this.enableBody && null === a.body ? this.game.physics.enable(a, this.physicsBodyType) : a.body && this.addToHash(a), !c && a.events && a.events.onAddedToGroup$dispatch(a, this), null === this.cursor && (this.cursor = a)), a
        ...
        return f.exists = e, f.visible = e, f.alive = e, this.addChild(f), f.z = this.children.length, this.enableBody && this.game.physics.enable(f, this.physicsBodyType, this.enableBodyDebug), f.events && f.events.onAddedToGroup$dispatch(f, this), null === this.cursor && (this.cursor = f), f
        ...
        start: function () {
            ...
            this.frame.push({
                type: this.STOP,
                time: Date.now()
            }), this.log.push(this.frame), this.count++, this.count === this.max && this.finish()
        }, cr: function () {
            this.frame.push({type: this.CANVAS_CLEAR})
        }, tu: function () {
            this.frame.push({type: this.UPDATE_TEXT, time: Date.now()})
        }, cts: function (a, b, c) {
            this.frame.push({type: this.CANVAS_RENDER_TILING_SPRITE, texture: a, width: b, height: c})
        }, gtt: function (a, b, c) {
            this.frame.push({type: this.GENERATE_TILING_TEXTURE, texture: a, width: b, height: c, time: Date.now()})
        }, cgc: function () {
            ...
            this.frame.push({type: this.CANVAS_GRAPHICS_POLY, time: Date.now(), points: a})
        }, cgrect: function () {
            ...
            this.frame.push({type: this.CANVAS_BLENDMODE, mode: a})
        }, cdcs: function () {
            ...
            return this.skipNext ? void(this.skipNext = !1) : void this.frame.push({
            ...
            this.frame.push({type: this.CANVAS_MASK_PUSH, mask: a})
        }, cmo: function () {
            this.frame.push({type: this.CANVAS_MASK_POP})
        }, record: function (a) {
            void 0 === a && (a = 1), this.on || (this.reset(), this.on = !0, this.max = 1)
        }, reset: function () {
            this.frame = [], this.log = [], this.count = 0, this.max = 1
        }, finish: function () {
            console.log(this.log), this.on = !1, this.win = window.open("about:blank", "FrameDebugger");
            var a = "<!DOCTYPE html><head><title>Display List Debugger Output</title><style>body { background: #383838; color: #b4b4b4; font-family: sans-serif; font-size: 12px;}h1 { float: right; padding: 0; margin: 0;}h2 { margin-top: 32px;}.thumbs { float: right; width: 512px; height: 512px; border: 2px solid white;}.strip { background: #4a4a4a; padding: 16px 0px 16px 32px;}li:Hover { background: #3e5f96; color: #fff;}</style></head><body><h1>Display List Debugger</h1></body></html>";
            this.win.document.open("text/html", "replace"), this.win.document.write(a), this.win.document.close();
            for (var b = this.win.document.body, c = 0; c < this.log.length; c++) {
                var d = 0, e = this.log[c], f = {}, g = 0, h = 0;
                this.addTag(b, "h2", "Frame " + c), this.addTag(b, "p", "Frame Start @ " + e[0].time);
                for (var i = this.addTag(b, "ol", null, "strip"), j = i, k = [i], l = 1; l < e.length - 1; l++) {
                    var m = e[l];
                    switch (m.type) {
                        case this.UPDATE_TEXT:
                            this.addTag(j, "li", "Text.updateText @ " + m.time);
                            break;
                        case this.GENERATE_TILING_TEXTURE:
                            this.addTag(j, "li", "Generate Tiling Texture @ " + m.time);
                            break;
                        case this.CANVAS_BLENDMODE:
                            this.addTag(j, "li", "Set Blend Mode: " + m.mode);
                            break;
                        case this.GRAPHICS_GENERATE_CACHED_SPRITE_FAST:
                            this.addTag(j, "li", "Graphics.Generate Cached Sprite (Fast) @ " + m.time + "(" + m.width + " x " + m.height + ")");
                            break;
                        case this.GRAPHICS_GENERATE_CACHED_SPRITE_SLOW:
                            this.addTag(j, "li", "Graphics.Generate Cached Sprite (Slow) @ " + m.time + "(" + m.width + " x " + m.height + ")");
                            break;
                        case this.CANVAS_DOC_START:
                            this.addTag(j, "li", "DisplayObjectContainer Start @ " + m.time);
                            var j = this.addTag(j, "ol");
                            k.push(j);
                            break;
                        case this.CANVAS_DOC_STOP:
                            k.pop(), j = k[k.length - 1], this.addTag(j, "li", "DisplayObjectContainer Stop @ " + m.time);
                            break;
                        case this.CANVAS_SPRITE_BATCH_START:
                            this.addTag(j, "li", "SpriteBatch Start @ " + m.time);
                            var j = this.addTag(j, "ol");
                            k.push(j);
                            break;
                        case this.CANVAS_SPRITE_BATCH_RENDER_FAST:
                            this.addTag(j, "li", "Child (FastPath) (" + m.width + " x " + m.height + ")"), d += this.addTexture(m, f), g++;
                            break;
                        case this.CANVAS_SPRITE_BATCH_RENDER_SLOW:
                            this.addTag(j, "li", "Child (SlowPath) (" + m.width + " x " + m.height + ")"), d += this.addTexture(m, f), g++;
                            break;
                        case this.CANVAS_SPRITE_BATCH_STOP:
                            k.pop(), j = k[k.length - 1], this.addTag(j, "li", "SpriteBatch Stop @ " + m.time);
                            break;
                        case this.CANVAS_RENDER_SPRITE:
                            this.addTag(j, "li", "Sprite (" + m.width + " x " + m.height + ")"), d += this.addTexture(m, f), g++;
                            break;
                        case this.CANVAS_RENDER_TEXT:
                            this.addTag(j, "li", "Text (" + m.width + " x " + m.height + ")"), d += this.addTexture(m, f), g++;
                            break;
                        case this.CANVAS_RENDER_TILING_SPRITE:
                            this.addTag(j, "li", "Tiling Sprite (" + m.width + " x " + m.height + ")"), d += this.addTexture(m, f), g++;
                            break;
                        case this.CANVAS_RENDER_GRAPHICS:
                            this.addTag(j, "li", "Graphics (Dynamic)");
                            break;
                        case this.CANVAS_RENDER_GRAPHICS_CACHED:
                            this.addTag(j, "li", "Graphics (Cached)");
                            break;
                        case this.CANVAS_GRAPHICS_START:
                            this.addTag(j, "li", "Render Graphics Start @ " + m.time);
                            var j = this.addTag(j, "ol");
                            k.push(j);
                            break;
                        case this.CANVAS_GRAPHICS_POLY:
                            this.addTag(j, "li", "Polygon (" + m.points + " points)"), h++;
                            break;
                        case this.CANVAS_GRAPHICS_RECT:
                            this.addTag(j, "li", "Rectangle"), h++;
                            break;
                        case this.CANVAS_GRAPHICS_CIRCLE:
                            this.addTag(j, "li", "Circle"), h++;
                            break;
                        case this.CANVAS_GRAPHICS_ROUNDED_RECT:
                            this.addTag(j, "li", "Rounded Rectangle"), h++;
                            break;
                        case this.CANVAS_GRAPHICS_ELIPSE:
                            this.addTag(j, "li", "Elipse"), h++;
                            break;
                        case this.CANVAS_GRAPHICS_STOP:
                            k.pop(), j = k[k.length - 1], this.addTag(j, "li", "Render Graphics Stop @ " + m.time)
                    }
                }
                var m = e[e.length - 1], n = m.time - e[0].time;
                this.addTag(b, "p", "Frame Stop @ " + m.time), this.addTag(b, "p", "Frame Duration: " + n + "ms"), this.addTag(b, "p", "Total Objects Rendered: " + g + " (" + d + " pixels)"), this.addTag(b, "p", "Canvas Primitives Rendered: " + h), this.addTag(b, "p", "Unique Textures:");
                var o = this.addTag(b, "ol");
                for (var p in f)this.addTag(o, "li", p + " - Times Used: " + f[p])
            }
        }, addTexture: function (a, b) {
            var c = a.texture.baseTexture.source.src;
            return void 0 === c && (c = a.texture.baseTexture.source._pixiId), b.hasOwnProperty(c) ? b[c]++ : b[c] = 1, a.width * a.height
        }, addImg: function (a, b) {
            a.appendChild(b.cloneNode(!0))
        }, addTag: function (a, b, c, d, e) {
            var f = this.win.document.createElement(b);
            return c && (f.textContent = c), d && (f.className = d), e && (f.style = e), a.appendChild(f), f
        }
    },c.Game = function (a, b, d, e, f, g, h, i) {
        return this.id = c.GAMES.push(this) - 1, this.config = null, this.physicsConfig = i, this.parent = "", this.width = 800, this.height = 600, this.resolution = 1, this._width = 800, this._height = 600, this.transparent = !1, this.antialias = !0, this.preserveDrawingBuffer = !1, this.clearBeforeRender = !0, this.fd = null, this.renderer = null, this.renderType = c.AUTO, this.state = null, this.isBooted = !1, this.isRunning = !1, this.raf = null, this.add = null, this.make = null, this.cache = null, this.input = null, this.load = null, this.math = null, this.net = null, this.scale = null, this.sound = null, this.stage = null, this.time = null, this.tweens = null, this.world = null, this.physics = null, this.plugins = null, this.rnd = null, this.device = c.Device, this.camera = null, this.canvas = null, this.context = null, this.debug = null, this.particles = null, this.create = null, this.lockRender = !1, this.stepping = !1, this.pendingStep = !1, this.stepCount = 0, this.onPause = null, this.onResume = null, this.onBlur = null, this.onFocus = null, this._paused = !1, this._codePaused = !1, this.currentUpdateID = 0, this.updatesThisFrame = 1, this._deltaTime = 0, this._lastCount = 0, this._spiraling = 0, this._kickstart = !0, this.fpsProblemNotifier = new c.Signal, this.forceSingleUpdate = !1, this._nextFpsNotification = 0, 1 === arguments.length && "object" == typeof arguments[0] ? this.parseConfig(arguments[0]) : (this.config = {enableDebug: !0}, "undefined" != typeof a && (this._width = a), "undefined" != typeof b && (this._height = b), "undefined" != typeof d && (this.renderType = d), "undefined" != typeof e && (this.parent = e), "undefined" != typeof g && (this.transparent = g), "undefined" != typeof h && (this.antialias = h), this.rnd = new c.RandomDataGenerator([(Date.now() * Math.random()).toString()]), this.state = new c.StateManager(this, f)), this.device.whenReady(this.boot, this), this
    },c.Game.prototype = {
        parseConfig: function (a) {
            ...
            if (!window.PhaserGlobal || !window.PhaserGlobal.hideBanner) {
                ...
                if (this.renderType === c.WEBGL ? (b = "WebGL", e++) : this.renderType == c.HEADLESS && (b = "Headless"), this.device.webAudio && (d = "WebAudio", e++), this.device.chrome) {
                    for (var f = ["%c %c %c Phaser v" + a + " | Pixi.js " + PIXI.VERSION + " | " + b + " | " + d + "  %c %c %c http://phaser.io %c♥%c♥%c♥", "background: #9854d8", "background: #6c2ca7", "color: #ffffff; background: #450f78;", "background: #6c2ca7", "background: #9854d8", "background: #ffffff"], g = 0; 3 > g; g++)e > g ? f.push("color: #ff2424; background: #fff") : f.push("color: #959595; background: #fff");
                    console.log.apply(console, f)
                } else window.console && console.log("Phaser v" + a + " | Pixi.js " + PIXI.VERSION + " | " + b + " | " + d + " | http://phaser.io")
            }
        }, setUpRenderer: function () {
            if (this.canvas = c.Canvas.create(this, this.width, this.height, this.config.canvasID, !0), this.config.canvasStyle ? this.canvas.style = this.config.canvasStyle : this.canvas.style["-webkit-full-screen"] = "width: 100%; height: 100%", this.renderType === c.HEADLESS || this.renderType === c.CANVAS || this.renderType === c.AUTO && !this.device.webGL) {
            ...
            if (this.time.update(a), this._kickstart)return this.updateLogic(this.time.desiredFpsMult), this.stage.updateTransform(), this.updateRender(this.time.slowMotion * this.time.desiredFps), void(this._kickstart = !1);
            if (this._spiraling > 1 && !this.forceSingleUpdate) this.time.time > this._nextFpsNotification && (this._nextFpsNotification = this.time.time + 1e4,
                ...
                var c = 0;
                for (this.updatesThisFrame = Math.floor(this._deltaTime / b), this.forceSingleUpdate && (this.updatesThisFrame = Math.min(1, this.updatesThisFrame)); this._deltaTime >= b && (this._deltaTime -= b, this.currentUpdateID = c, this.updateLogic(this.time.desiredFpsMult), this.stage.updateTransform(), c++, !this.forceSingleUpdate || 1 !== c);)this.time.refresh();
            ...
            this.lockRender || (this.fd.on && this.fd.start(), this.state.preRender(a), this.renderer.render(this.stage), this.plugins.render(a), this.state.render(a), this.plugins.postRender(a), this.fd.on && this.fd.stop())
        }, enableStep: function () {
            ...
            this._paused || (this._paused = !0, this.time.gamePaused(), this.sound.setMute(), this.onPause.dispatch(a), this.device.cordova && this.device.iOS && (this.lockRender = !0))
        }, gameResumed: function (a) {
            this._paused && !this._codePaused && (this._paused = !1, this.time.gameResumed(), this.input.reset(), this.sound.unsetMute(), this.onResume.dispatch(a), this.device.cordova && this.device.iOS && (this.lockRender = !1))
        ...
        start: function (a, b) {
            ...
            return void 0 === c && (c = !0), !this.enabled || 0 === this.sprite.scale.x || 0 === this.sprite.scale.y || this.priorityID < this.game.input.minPriorityID ? !1 : (c || !this.pixelPerfectClick && !this.pixelPerfectOver) && (this.priorityID > a || this.priorityID === a && this.sprite.renderOrderID < b) ? !0 : !1
            ...
            return a.isDown && this.enabled && this.sprite && this.sprite.parent && this.sprite.visible && this.sprite.parent.visible && this.game.input.hitTest(this.sprite, a, this._tempPoint) ? (void 0 === b && (b = !1), !b && this.pixelPerfectClick ? this.checkPixel(this._tempPoint.x, this._tempPoint.y) : !0) : !1
        }, checkPointerOver: function (a, b) {
            return this.enabled && this.sprite && this.sprite.parent && this.sprite.visible && this.sprite.parent.visible && this.game.input.hitTest(this.sprite, a, this._tempPoint) ? (void 0 === b && (b = !1), !b && this.pixelPerfectOver ? this.checkPixel(this._tempPoint.x, this._tempPoint.y) : !0) : !1
            ...
            if (null !== this.sprite) {
                ...
                (b.isOver === !1 || a.dirty) && (b.isOver = !0, b.isOut = !1, b.timeOver = this.game.time.time, b.x = a.x - this.sprite.x, b.y = a.y - this.sprite.y, this.useHandCursor && b.isDragged === !1 && (this.game.canvas.style.cursor = "pointer", this._setHandCursor = !0), this.sprite && this.sprite.events && this.sprite.events.onInputOver$dispatch(this.sprite, a))
            }
        }, _pointerOutHandler: function (a) {
            if (null !== this.sprite) {
                var b = this._pointerData[a.id];
                b.isOver = !1, b.isOut = !0, b.timeOut = this.game.time.time, this.useHandCursor && b.isDragged === !1 && (this.game.canvas.style.cursor = "default", this._setHandCursor = !1), this.sprite && this.sprite.events && this.sprite.events.onInputOut$dispatch(this.sprite, a)
            }
            ...
            if (null !== this.sprite) {
                ...
                if (!b.isDown && b.isOver) {
                    ...
                    b.isDown = !0, b.isUp = !1, b.timeDown = this.game.time.time, this.sprite && this.sprite.events && this.sprite.events.onInputDown$dispatch(this.sprite, a), a.dirty = !0, this.draggable && this.isDragged === !1 && this.startDrag(a), this.bringToTop && this.sprite.bringToTop()
                }
            ...
            if (null !== this.sprite) {
                ...
                if (b.isDown && a.isUp) {
                    ...
                    this.sprite && this.sprite.events && (this.sprite.events.onInputUp$dispatch(this.sprite, a, c), c && (c = this.checkPointerOver(a))), b.isOver = c, !c && this.useHandCursor && (this.game.canvas.style.cursor = "default", this._setHandCursor = !1), a.dirty = !0, this.draggable && this.isDragged && this._draggedPointerID === a.id && this.stopDrag(a)
                }
            }
    ...
    },c.InputHandler.prototype.constructor = c.InputHandler,c.Component = function () {
        ...
        cropRect: null, _crop: null, crop: function (a, b) {
            ...
            if (this.cropRect) {
                ...
                var a = Math.max(this._frame.x, this._crop.x), b = Math.max(this._frame.y, this._crop.y),
        ...
        destroyPhase: !1, destroy: function (a) {
            if (null !== this.game && !this.destroyPhase) {
                void 0 === a && (a = !0), this.destroyPhase = !0, this.events && this.events.onDestroy$dispatch(this), this.parent && (this.parent instanceof c.Group ? this.parent.remove(this) : this.parent.removeChild(this)), this.input && this.input.destroy(), this.animations && this.animations.destroy(), this.body && this.body.destroy(), this.events && this.events.destroy();
    ...
    c.Component.FixedToCamera = function () {
        ...
        alive: !0, lifespan: 0, revive: function (a) {
            return void 0 === a && (a = 1), this.alive = !0, this.exists = !0, this.visible = !0, "function" == typeof this.heal && this.heal(a), this.events && this.events.onRevived$dispatch(this), this
        }, kill: function () {
        ...
        setScaleMinMax: function (a, b, d, e) {
            void 0 === b ? b = d = e = a : void 0 === d && (d = e = b, b = a), null === a ? this.scaleMin = null : this.scaleMin ? this.scaleMin.set(a, b) : this.scaleMin = new c.Point(a, b), null === d ? this.scaleMax = null : this.scaleMax ? this.scaleMax.set(d, e) : this.scaleMax = new c.Point(d, e)
        }
    ...
    c.Button.prototype.clearFrames = function () {
        ...
        b.justReleased() && (this.justReleasedPreventsOver & b.pointerMode) === b.pointerMode || (this.changeStateFrame(f), (!this.onOverMouseOnly || b.isMouse) && (this.playStateSound(f), this.onInputOver && this.onInputOver.dispatch(this, b)))
        ...
        if (this.playStateSound(i), this.onInputUp && this.onInputUp.dispatch(this, b, c), !this.freezeFrames)if (this.forceOut === !0 || (this.forceOut & b.pointerMode) === b.pointerMode) this.changeStateFrame(g); else {
            var d = this.changeStateFrame(i);
            d || (c ? this.changeStateFrame(f) : this.changeStateFrame(g))
        }
    ...
    }, c.SpriteBatch.prototype = c.Utils.extend(!0, c.SpriteBatch.prototype, c.Group.prototype, PIXI.SpriteBatch.prototype), c.SpriteBatch.prototype.constructor = c.SpriteBatch, c.BitmapData = function (a, b, d, e) {
        (void 0 === d || 0 === d) && (d = 256), (void 0 === e || 0 === e) && (e = 256), this.game = a, this.key = b, this.width = d, this.height = e, this.canvas = PIXI.CanvasPool.create(this, d, e), this.context = this.canvas.getContext("2d", {alpha: !0}), this.ctx = this.context, this.imageData = this.context.getImageData(0, 0, d, e), this.data = null, this.imageData && (this.data = this.imageData.data), this.pixels = null, this.data && (this.imageData.data.buffer ? (this.buffer = this.imageData.data.buffer, this.pixels = new Uint32Array(this.buffer)) : window.ArrayBuffer ? (this.buffer = new ArrayBuffer(this.imageData.data.length), this.pixels = new Uint32Array(this.buffer)) : this.pixels = this.imageData.data), this.baseTexture = new PIXI.BaseTexture(this.canvas), this.texture = new PIXI.Texture(this.baseTexture), this.textureFrame = new c.Frame(0, 0, 0, d, e, "bitmapData"), this.texture.frame = this.textureFrame, this.type = c.BITMAPDATA, this.disableTextureUpload = !1, this.dirty = !1, this.cls = this.clear, this._image = null, this._pos = new c.Point, this._size = new c.Point, this._scale = new c.Point, this._rotate = 0, this._alpha = {
            prev: 1,
            current: 1
        }, this._anchor = new c.Point, this._tempR = 0, this._tempG = 0, this._tempB = 0, this._circle = new c.Circle, this._swapCanvas = PIXI.CanvasPool.create(this, d, e)
        ...
        move: function (a, b, c) {
            ...
            return void 0 === a && (a = 0), void 0 === b && (b = 0), void 0 === c && (c = this.width), void 0 === d && (d = this.height), this.context.clearRect(a, b, c, d), this.update(), this.dirty = !0, this
            ...
            if ((void 0 === a || null === a) && (a = this), this._image = a, a instanceof c.Sprite || a instanceof c.Image || a instanceof c.Text || a instanceof PIXI.Sprite) this._pos.set(a.texture.crop.x, a.texture.crop.y), this._size.set(a.texture.crop.width, a.texture.crop.height), this._scale.set(a.scale.x, a.scale.y), this._anchor.set(a.anchor.x, a.anchor.y), this._rotate = a.rotation, this._alpha.current = a.alpha, this._image = a.texture.baseTexture.source, (void 0 === g || null === g) && (g = a.x), (void 0 === h || null === h) && (h = a.y), a.texture.trim && (g += a.texture.trim.x - a.anchor.x * a.texture.trim.width, h += a.texture.trim.y - a.anchor.y * a.texture.trim.height), 16777215 !== a.tint && (a.cachedTint !== a.tint && (a.cachedTint = a.tint, a.tintedTexture = PIXI.CanvasTinter.getTintedTexture(a, a.tint)), this._image = a.tintedTexture); else {
    ...
    }, c.BitmapData.prototype.constructor = c.BitmapData, c.RenderTexture = function (a, b, d, e, f, g) {
        ...
        a = a || {}, a.font = a.font || "bold 20pt Arial", a.backgroundColor = a.backgroundColor || null, a.fill = a.fill || "black", a.align = a.align || "left", a.boundsAlignH = a.boundsAlignH || "left", a.boundsAlignV = a.boundsAlignV || "top", a.stroke = a.stroke || "black", a.strokeThickness = a.strokeThickness || 0, a.wordWrap = a.wordWrap || !1, a.wordWrapWidth = a.wordWrapWidth || 100, a.shadowOffsetX = a.shadowOffsetX || 0, a.shadowOffsetY = a.shadowOffsetY || 0, a.shadowColor = a.shadowColor || "rgba(0,0,0,0)", a.shadowBlur = a.shadowBlur || 0, a.tabs = a.tabs || 0;
        var b = this.fontToComponents(a.font);
        return a.fontStyle && (b.fontStyle = a.fontStyle), a.fontVariant && (b.fontVariant = a.fontVariant), a.fontWeight && (b.fontWeight = a.fontWeight), a.fontSize && ("number" == typeof a.fontSize && (a.fontSize = a.fontSize + "px"), b.fontSize = a.fontSize), this._fontComponents = b, a.font = this.componentsToFont(this._fontComponents), this.style = a, this.dirty = !0, this
        ...
        var n = f.fontSize + this.style.strokeThickness + this.padding.y, o = n * b.length, p = this._lineSpacing;
        if (0 > p && Math.abs(p) > n && (p = -n), 0 !== p) {
            var m = p * (b.length - 1);
            o += m
        }
        this.canvas.height = o * this._res, this.context.scale(this._res, this._res), navigator.isCocoonJS && this.context.clearRect(0, 0, this.canvas.width, this.canvas.height), this.style.backgroundColor && (this.context.fillStyle = this.style.backgroundColor, this.context.fillRect(0, 0, this.canvas.width, this.canvas.height)), this.context.fillStyle = this.style.fill, this.context.font = this.style.font, this.context.strokeStyle = this.style.stroke, this.context.textBaseline = "alphabetic", this.context.lineWidth = this.style.strokeThickness, this.context.lineCap = "round", this.context.lineJoin = "round";
        var q, r;
        for (this._charCount = 0, g = 0; g < b.length; g++)q = this.style.strokeThickness / 2, r = this.style.strokeThickness / 2 + g * n + f.ascent, g > 0 && (r += p * g), "right" === this.style.align ? q += e - d[g] : "center" === this.style.align && (q += (e - d[g]) / 2), this.autoRound && (q = Math.round(q), r = Math.round(r)), this.colors.length > 0 || this.strokeColors.length > 0 || this.fontWeights.length > 0 || this.fontStyles.length > 0 ? this.updateLine(b[g], q, r) : (this.style.stroke && this.style.strokeThickness && (this.updateShadow(this.style.shadowStroke), 0 === c ? this.context.strokeText(b[g], q, r) : this.renderTabLine(b[g], q, r, !1)), this.style.fill && (this.updateShadow(this.style.shadowFill), 0 === c ? this.context.fillText(b[g], q, r) : this.renderTabLine(b[g], q, r, !0)));
        this.updateTexture()
        ...
        this.dirty && (a.fd.on && a.fd.tu(), this.updateText(), this.dirty = !1), a.fd.on && a.fd.ct(this.texture, this.texture.width, this.texture.height, this.texture.baseTexture.resolution), PIXI.Sprite.prototype._renderCanvas.call(this, a)
    ...
    }), c.Text.fontPropertiesCache = {}, c.Text.fontPropertiesCanvas = PIXI.CanvasPool.create(c.Text.fontPropertiesCanvas), c.Text.fontPropertiesContext = c.Text.fontPropertiesCanvas.getContext("2d"), c.TileSprite = function () {
    }, c.Device = function () {
    ...
    c.Math.degToRad = function (a) {
        ...
        rnd: function () {
            ...
            if (this.s0 = this.hash(" "), this.s1 = this.hash(this.s0), this.s2 = this.hash(this.s1), this.c = 1, a)for (var b = 0; b < a.length && null != a[b]; b++) {
                var c = a[b];
                this.s0 -= this.hash(c), this.s0 += ~~(this.s0 < 0), this.s1 -= this.hash(c), this.s1 += ~~(this.s1 < 0), this.s2 -= this.hash(c),
                    this.s2 += ~~(this.s2 < 0)
            }
        }, hash: function (a) {
            var b, c, d;
    ...
    return c.Net = l, c.Net.prototype = {
        isDisabled: !0,
        getHostName: l,
        checkDomainName: l,
        updateQueryString: l,
        ...
        to: function (a, b, d, e, f, g, h) {
            ...
            return void 0 === a && (a = !1), this.isRunning = !1, this._onUpdateCallback = null, this._onUpdateCallbackContext = null, a && (this.onComplete.dispatch(this.target, this), this.chainedTween && this.chainedTween.start()), this.manager.remove(this), this
            ...
            return void 0 === a && (a = !0), a ? this.repeatAll(-1) : this.repeatCounter = 0, this
        ...
        loadFrameData: function (a, b) {
            ...
            void 0 === b && (b = !1), "string" == typeof a ? this._anims[a] && (this.currentAnim = this._anims[a], this.currentAnim.stop(b)) : this.currentAnim && this.currentAnim.stop(b)
        }, update: function () {
    ...
    }, c.Cache.CANVAS = 1, c.Cache.IMAGE = 2, c.Cache.TEXTURE = 3, c.Cache.SOUND = 4, c.Cache.TEXT = 5, c.Cache.PHYSICS = 6, c.Cache.TILEMAP = 7, c.Cache.BINARY = 8, c.Cache.BITMAPDATA = 9, c.Cache.BITMAPFONT = 10, c.Cache.JSON = 11, c.Cache.XML = 12, c.Cache.VIDEO = 13, c.Cache.SHADER = 14, c.Cache.RENDER_TEXTURE = 15, c.Cache.prototype = {
        addCanvas: function (a, b, c) {
            ...
            return e.frameData.addFrame(new c.Frame(0, 0, 0, d.width, d.height, b)), this._cache.image[a] = e, this._resolveURL(b, e), e
            ...
            "json" === f ? i.font = c.LoaderParser.jsonBitmapFont(e, i.base, g, h) : i.font = c.LoaderParser.xmlBitmapFont(e, i.base, g, h), this._cache.bitmapFont[a] = i, this._resolveURL(b, i)
    ...
    }, c.SoundManager = function () {
    }, c.SoundManager.prototype.boot = function () {
    }, c.SoundManager.prototype.update = function () {
    },c.SoundManager.prototype.destroy = function () {
    },c.SoundManager.prototype.setMute = function () {
    },c.SoundManager.prototype.unsetMute = function () {
    },c.SoundManager.prototype.constructor = c.SoundManager,c.ScaleManager = function (a, b, d) {
        ...
        boot: function () {
            ...
            }, document.addEventListener("webkitfullscreenchange", this._fullScreenChange, !1), document.addEventListener("mozfullscreenchange", this._fullScreenChange, !1), document.addEventListener("MSFullscreenChange", this._fullScreenChange, !1), document.addEventListener("fullscreenchange", this._fullScreenChange, !1), document.addEventListener("webkitfullscreenerror", this._fullScreenError, !1), document.addEventListener("mozfullscreenerror", this._fullScreenError, !1), document.addEventListener("MSFullscreenError", this._fullScreenError, !1), document.addEventListener("fullscreenerror", this._fullScreenError, !1)), this.game.onResume.add(this._gameResumed, this), this.dom.getOffset(this.game.canvas, this.offset), this.bounds.setTo(this.offset.x, this.offset.y, this.width, this.height), this.setGameSize(this.game.width, this.game.height), this.screenOrientation = this.dom.getScreenOrientation(this.compatibility.orientationFallback), c.FlexGrid && (this.grid = new c.FlexGrid(this, this.width, this.height)), this._booted = !0, this._pendingScaleMode && (this.scaleMode = this._pendingScaleMode, this._pendingScaleMode = null)
        }, parseConfig: function (a) {
            a.scaleMode && (this._booted ? this.scaleMode = a.scaleMode : this._pendingScaleMode = a.scaleMode), a.fullScreenScaleMode && (this.fullScreenScaleMode = a.fullScreenScaleMode), a.fullScreenTarget && (this.fullScreenTarget = a.fullScreenTarget)
            ...
            if (d) {
                var g = d.getBoundingClientRect(), h = d.offsetParent.getBoundingClientRect();
        ...
        boot: function () {
            this.game.renderType === c.CANVAS ? this.context = this.game.context : (this.bmd = this.game.make.bitmapData(this.game.width, this.game.height), this.sprite = this.game.make.image(0, 0, this.bmd), this.game.stage.addChild(this.sprite), this.canvas = PIXI.CanvasPool.create(this, this.game.width, this.game.height), this.context = this.canvas.getContext("2d"))
        }, preUpdate: function () {
    ...
    },c.LinkedList.prototype.constructor = c.LinkedList,c.Create = function () {
    },c.Color = {
        packPixel: function (a, b, d, e) {
            ...
            return a.rgba = "rgba(" + a.r.toString() + "," + a.g.toString() + "," + a.b.toString() + "," + a.a.toString() + ")", a.color = c.Color.getColor(a.r, a.g, a.b), a.color32 = c.Color.getColor32(a.a, a.r, a.g, a.b), a
...
var b6U = {
    'K3I': function (U, E) {
        ...
        Phaser["ParticleStorm"]["BITMAP_DATA"] = U;
    }, 'e0': function (U, E) {
        return U * E;
    }, 'L1': function (U, E) {
        return U > E;
        ...
        Phaser["ParticleStorm"]["RENDERTEXTURE"] = U;
    }, 'G6': function (U, E) {
        return U * E;
    }, 'x0': function (U, E) {
        return U === E;
        ...
        var R = function (U, E) {
            var k = E & 0xffff, f = E - k;
            return ((f * U | 0) + (k * U | 0)) | 0;
        }, A = function (U, E, k) {
            if (Q[k] !== undefined) {
                return Q[k];
            }
            var f = 0xcc9e2d51, F = 0x1b873593;
            var X = k;
            var v = E & ~0x3;
            for (var s = 0; s < v; s += 4) {
                var o = (U["charCodeAt"](s) & 0xff) | ((U["charCodeAt"](s + 1) & 0xff) << 8) | ((U["charCodeAt"](s + 2) & 0xff) << 16) | ((U["charCodeAt"](s + 3) & 0xff) << 24);
                o = R(o, f);
                o = ((o & 0x1ffff) << 15) | (o >>> 17);
                o = R(o, F);
                X ^= o;
            ...
            switch (E % 4) {
                case 3:
                    o = (U["charCodeAt"](v + 2) & 0xff) << 16;
                case 2:
                    o |= (U["charCodeAt"](v + 1) & 0xff) << 8;
                case 1:
                    o |= (U["charCodeAt"](v) & 0xff);
                    o = R(o, f);
                    o = ((o & 0x1ffff) << 15) | (o >>> 17);
                    o = R(o, F);
                    X ^= o;
        ...
        Phaser["ParticleStorm"]["SPRITE_BATCH"] = U;
    }, 'D2': function (U, E) {
        return U - E;
    }, 'M8I': function (U, E) {
        return U < E;
...
Phaser["ParticleStorm"] = function (U, E) {
    Phaser["Plugin"]["call"](this, U, E);
    this["emitters"] = [];
    this["dataList"] = {};
    var k = PIXI["canUseNewCanvasBlendModes"]();
    this["blendModeMap"] = {
        "NORMAL": [0, 'source-over'],
        "ADD": [1, 'lighter'],
        "MULTIPLY": [2, (k) ? 'multiply' : 'source-over'],
        "SCREEN": [3, (k) ? 'screen' : 'source-over'],
        "OVERLAY": [4, (k) ? 'overlay' : 'source-over'],
        "DARKEN": [5, (k) ? 'darken' : 'source-over'],
        "LIGHTEN": [6, (k) ? 'lighten' : 'source-over'],
        "COLOR_DODGE": [7, (k) ? 'color-dodge' : 'source-over'],
        "COLOR_BURN": [8, (k) ? 'color-burn' : 'source-over'],
        "HARD_LIGHT": [9, (k) ? 'hard-light' : 'source-over'],
        "SOFT_LIGHT": [10, (k) ? 'soft-light' : 'source-over'],
        "DIFFERENCE": [11, (k) ? 'difference' : 'source-over'],
        "EXCLUSION": [12, (k) ? 'exclusion' : 'source-over'],
        "HUE": [13, (k) ? 'hue' : 'source-over'],
        "SATURATION": [14, (k) ? 'saturation' : 'source-over'],
        "COLOR": [15, (k) ? 'color' : 'source-over'],
        "LUMINOSITY": [16, (k) ? 'luminosity' : 'source-over']
    };
...
Phaser.ParticleStorm.prototype.createEmitter = function (U, E, k) {
    var f = new Phaser["ParticleStorm"]["Emitter"](this, U, E, k);
    this["emitters"]["push"](f);
    return f;
};
Phaser.ParticleStorm.prototype.removeEmitter = function (U) {
    for (var E = 0; b6U["m"](E, this["emitters"].length); E++) {
        if (b6U["l"](this["emitters"][E], U)) {
            this["emitters"]["splice"](E, 1);
            return;
        }
    }
};
Phaser.ParticleStorm.prototype.addData = function (U, E) {
    if (b6U["e"](U, undefined)) {
        return this;
    }
    if (Array["isArray"](U)) {
        for (var k = 0; b6U["j"](k, U.length); k++) {
            this["dataList"][U[k]] = this["game"]["cache"]["getJSON"](U[k]);
        }
    } else {
        if (b6U["D"](E, undefined)) {
            this["dataList"][U] = E;
        } else {
            this["dataList"][U] = this["game"]["cache"]["getJSON"](U);
        }
    }
    return this;
};
Phaser.ParticleStorm.prototype.getData = function (U) {
    return this["dataList"][U];
};
Phaser.ParticleStorm.prototype.clearData = function (U) {
    if (b6U["G"](U, undefined)) {
        this["dataList"] = {};
    } else {
        if (Array["isArray"](U)) {
            for (var E = 0; b6U["T"](E, U.length); E++) {
                delete  this["dataList"][U[E]];
            }
        } else {
            delete  this["dataList"][U];
        }
    }
    return this;
};
Phaser.ParticleStorm.prototype.cloneData = function (U, E) {
    if (b6U["u"](U, undefined)) {
        return this;
    }
    if (Array["isArray"](U)) {
        for (var k = 0; b6U["U8"](k, U.length); k++) {
            this["dataList"][U[k]] = Phaser["Utils"]["extend"](true, this["game"]["cache"]["getJSON"](U[k]));
        }
    } else {
        if (b6U["E8"](E, undefined)) {
            this["dataList"][U] = Phaser["Utils"]["extend"](true, E);
        } else {
            this["dataList"][U] = Phaser["Utils"]["extend"](true, this["game"]["cache"]["getJSON"](U));
        }
    }
    return this;
};
Phaser.ParticleStorm.prototype.createPointZone = function (U, E) {
    return new Phaser["ParticleStorm"]["Zones"]["Point"](this["game"], U, E);
};
Phaser.ParticleStorm.prototype.createLineZone = function (U, E, k, f) {
    return new Phaser["ParticleStorm"]["Zones"]["Line"](this["game"], U, E, k, f);
};
Phaser.ParticleStorm.prototype.createRectangleZone = function (U, E) {
    return new Phaser["ParticleStorm"]["Zones"]["Rectangle"](this["game"], U, E);
};
Phaser.ParticleStorm.prototype.createCircleZone = function (U) {
    var E = -404146181, k = -416265344, f = 2;
    for (var F = 1; b6U.A0I.l0I(F.toString(), F.toString().length, 4660715) !== E; F++) {
        this.pool.push(p);
    ...
    if (b6U.A0I.l0I(f.toString(), f.toString().length, 5419642) !== k) {
        this.display.destroy();
        args.push(arguments[i]);
        this.graph.fromData(data.acceleration, this.acceleration.x);
        this.graph.fromData(data.ax, this.acceleration.x);
    }
    return new Phaser["ParticleStorm"]["Zones"]["Circle"](this["game"], U);
};
Phaser.ParticleStorm.prototype.createEllipseZone = function (U, E) {
    return new Phaser["ParticleStorm"]["Zones"]["Ellipse"](this["game"], U, E);
};
Phaser.ParticleStorm.prototype.createLinearSplineZone = function (U, E, k) {
    return new Phaser["ParticleStorm"]["Zones"]["Spline"](this["game"], 0, U, E, k);
};
Phaser.ParticleStorm.prototype.createBezierSplineZone = function (U, E, k) {
    return new Phaser["ParticleStorm"]["Zones"]["Spline"](this["game"], 1, U, E, k);
};
Phaser.ParticleStorm.prototype.createCatmullSplineZone = function (U, E, k) {
    return new Phaser["ParticleStorm"]["Zones"]["Spline"](this["game"], 2, U, E, k);
};
Phaser.ParticleStorm.prototype.createSplineZone = function (U, E, k, f) {
    return new Phaser["ParticleStorm"]["Zones"]["Spline"](this["game"], U, E, k, f);
};
Phaser.ParticleStorm.prototype.createTextZone = function (U) {
    return new Phaser["ParticleStorm"]["Zones"]["Text"](this["game"], U);
};
Phaser.ParticleStorm.prototype.createImageZone = function (U) {
    return new Phaser["ParticleStorm"]["Zones"]["Image"](this["game"], U);
};
Phaser.ParticleStorm.prototype.update = function () {
    if (!this["active"]) {
        return;
    }
    for (var U = 0; b6U["k8"](U, this["emitters"].length); U++) {
        if (this["emitters"][U]["enabled"] && !this["emitters"][U]["manualUpdate"]) {
            this["emitters"][U]["update"]();
        }
    }
};
Phaser["ParticleStorm"]["Emitter"] = function (U, E, k, f) {
    this["game"] = U["game"];
    this.parent = U;
    this["renderer"] = null;
...
Phaser.ParticleStorm.Emitter.prototype = {
    init: function (U, E, k) {
        if (b6U["f8"](U, undefined)) {
            U = Phaser["ParticleStorm"]["SPRITE"];
        }
        var f = this["game"].width, F = this["game"].height;
        switch (U) {
            ...
            case Phaser["ParticleStorm"]["PIXEL"]:
                this["renderer"] = new Phaser["ParticleStorm"]["Renderer"]["Pixel"](this, f, F);
                break;
            case Phaser["ParticleStorm"]["RENDERTEXTURE"]:
                this["renderer"] = new Phaser["ParticleStorm"]["Renderer"]["RenderTexture"](this, f, F);
                break;
            ...
            case Phaser["ParticleStorm"]["BITMAP_DATA"]:
                this["renderer"] = new Phaser["ParticleStorm"]["Renderer"]["BitmapData"](this, f, F);
                break;
            default:
        ...
        this["renderType"] = U;
        if (E) {
            this["force"]["set"](E["x"], E["y"]);
        }
        if (k) {
            this["scrollSpeed"]["set"](k["x"], k["y"]);
        }
        this["list"] = [];
        this["pool"] = [];
        this["wells"] = [];
        this["enabled"] = true;
    }, addToWorld: function (U) {
        if (b6U["i8"](U, undefined)) {
            U = this["game"]["world"];
        }
        return this["renderer"]["addToWorld"](U);
    }, createGravityWell: function (U, E, k, f, F) {
        var X = new Phaser["ParticleStorm"]["GravityWell"](this, U, E, k, f, F);
        this["wells"]["push"](X);
        return X;
    }, seed: function (U) {
        for (var E = 0; b6U["v8"](E, U); E++) {
            var k = new Phaser["ParticleStorm"]["Particle"](this);
            this["pool"]["push"](k);
        }
        return this;
    }, emitDelayed: function (U, E, k, f, F) {
        if (!this["enabled"] || !this.parent.dataList[E] || b6U["s8"](U, 0)) {
            return null;
        }
        this["timerEvent"] = this["timer"]["add"](U, this["emit"], this, E, k, f, F);
        this["timer"]["start"]();
        return this["timerEvent"];
    }, emit: function (U, E, k, f) {
        if (!this["enabled"] || !this.parent.dataList[U]) {
            return null;
        }
        this["batch"] = [];
        this["_pCount"] = 0;
        this["_step"]["x"] = 0;
        this["_step"]["y"] = 0;
        if (b6U["R8"](E, undefined)) {
            E = 0;
        }
        if (b6U["Q8"](k, undefined)) {
            k = 0;
        }
        if (!f) {
            return this["emitParticle"](U, E, k, null);
        }
        var F = (f["hasOwnProperty"]('total')) ? f["total"] : 1;
        if (b6U["c8"](f["xStep"], 0)) {
            this["_step"]["x"] = f["xStep"];
        } else {
            this["_step"]["x"] = 0;
        }
        if (b6U["j8"](f["yStep"], 0)) {
            this["_step"]["y"] = f["yStep"];
        } else {
            this["_step"]["y"] = 0;
        }
        ...
        if (f["delay"]) {
            ...
            if (typeof f["delay"] === 'number') {
                this["_delay"]["start"] = f["delay"];
                this["_delay"]["step"] = 0;
                this["_delay"]["visible"] = false;
            } else {
                this["_delay"]["start"] = (f["delay"]["start"]) ? f["delay"]["start"] : 0;
                this["_delay"]["step"] = (f["delay"]["step"]) ? f["delay"]["step"] : 0;
                this["_delay"]["visible"] = (f["delay"]["visible"]) ? true : false;
            }
        }
        if (f["zone"]) {
            if ((b6U["Y8"](f["random"], undefined) && b6U["V8"](f["full"], undefined) && b6U["G8"](f["percent"], undefined)) || f["random"]) {
                f["zone"]["emit"](this, U, E, k, F, f["setAlpha"], f["setColor"]);
            } else if (b6U["r8"](f["percent"], undefined) && (b6U["n8"](f["full"], undefined) || !f["random"])) {
                f["zone"]["emitFull"](this, U, E, k, f["step"], f["spacing"], f["setAlpha"], f["setColor"]);
            } else if (b6U["H8"](f["percent"], undefined)) {
                var X = 0;
                if (typeof f["percent"] === 'number') {
                    X = f["percent"];
                } else {
                    if (f["percent"]["hasOwnProperty"]('min')) {
                        X = this["game"]["rnd"]["between"](f["percent"]["min"], f["percent"]["max"]);
                    } else if (f["percent"]["callback"]) {
                        X = f["percent"]["callback"]["call"](f["percent"]["context"], this);
                    }
                }
                f["zone"]["emitPercent"](this, U, E, k, F, X);
            }
        } else {
            for (var v = 0; b6U["L8"](v, F); v++) {
                this["emitParticle"](U, E, k, null);
            }
        }
        if (f["radiate"]) {
            for (var s = 0; b6U["z3"](s, this["batch"].length); s++) {
                this["batch"][s]["radiate"](f["radiate"]["velocity"], f["radiate"]["from"], f["radiate"]["to"]);
            }
        } else if (f["radiateFrom"]) {
            for (var s = 0; b6U["M3"](s, this["batch"].length); s++) {
                this["batch"][s]["radiateFrom"](f["radiateFrom"]["x"], f["radiateFrom"]["y"], f["radiateFrom"]["velocity"]);
            }
        }
        var o = (f["hasOwnProperty"]('repeat')) ? f["repeat"] : 0;
        if (b6U["O3"](o, 0)) {
            var R = (f["hasOwnProperty"]('frequency')) ? f["frequency"] : 250;
            delete  f["repeat"];
            if (o === -1) {
                this["timerEvent"] = this["timer"]["loop"](R, this["emit"], this, U, E, k, f);
            } else if (b6U["W3"](o, 0)) {
                this["timerEvent"] = this["timer"]["repeat"](R, o, this["emit"], this, U, E, k, f);
            }
            this["timer"]["start"]();
        }
        this["_pCount"] = 0;
        return this["batch"];
    }, emitParticle: function (U, E, k, f) {
        var F = this["pool"]["pop"]();
        if (!F) {
            F = new this["particleClass"](this);
        }
        F.parent = f;
        if (Array["isArray"](E)) {
            E = this["game"]["rnd"]["between"](E[0], E[1]);
        }
        if (Array["isArray"](k)) {
            k = this["game"]["rnd"]["between"](k[0], k[1]);
        }
        E += (b6U["X3"](this["_step"]["x"], this["_pCount"]));
        k += (b6U["P3"](this["_step"]["y"], this["_pCount"]));
        F["reset"](this["renderer"], E, k, this.parent.dataList[U]);
        if (F["alive"]) {
            if (!f && this["_delay"]["enabled"]) {
                F["delay"] += this["_delay"]["start"] + (b6U["m3"](this["_pCount"], this["_delay"]["step"]));
                F["delayVisible"] = this["_delay"]["visible"];
            }
            this["list"]["push"](F);
            this["batch"]["push"](F);
            if (!f) {
            ...
            F["kill"]();
            if (this["onKill"]) {
                this["onKill"]["dispatch"](this, F);
            }
            this["pool"]["push"](F);
        }
        return F;
    }, update: function () {
        var U = this["game"]["time"]["elapsed"];
        this["renderer"]["preUpdate"]();
        for (var E = b6U["l3"](this["list"].length, 1); b6U["e3"](E, 0); E--) {
            var k = this["list"][E];
            if (!k["ignoreScrollSpeed"]) {
                k.transform["x"] += this["scrollSpeed"]["x"];
                k.transform["y"] += this["scrollSpeed"]["y"];
            }
            for (var f = 0; b6U["Z3"](f, this["wells"].length); f++) {
                if (this["wells"][f]["active"]) {
                    this["wells"][f]["step"](k);
                }
            }
            if (!k["step"](U, this["force"])) {
                k["kill"]();
                this["pool"]["push"](k);
        ...
        return this["list"].length;
    }, updateFrequency: function (U, E, k, f) {
        if (U["at"]) {
            var F = 0;
            for (var X = 0; b6U["t3"](X, U["at"].length); X++) {
                var v = U["at"][X];
                if ((b6U["D3"](v["time"], k) || (b6U["I3"](v["time"], 0) && b6U["C3"](k, 0))) && b6U["T3"](v["time"], f)) {
                    if (b6U["N3"](v["value"], 0) && b6U["S3"](v["value"], 1.0)) {
                        if (b6U["d4"](Math["random"](), v["value"])) {
                            F += 1;
                        }
                    } else {
                        F += v["value"];
        ...
        return b6U["p4"](this["graph"]["getParamArea"](U, k, f), E);
    }, forEach: function (U, E) {
        if (b6U["x4"](arguments.length, 2)) {
            for (var k = 0; b6U["F4"](k, this["list"].length); k++) {
                U["call"](E, this["list"][k]);
            }
        } else {
            var f = [null];
            for (var k = 2; b6U["y4"](k, arguments.length); k++) {
                f["push"](arguments[k]);
            }
            for (var k = 0; b6U["o4"](k, this["list"].length); k++) {
                f[0] = this["list"][k];
                U["apply"](E, f);
            }
        }
    }, forEachNew: function (U, E) {
        if (b6U["a4"](this["batch"].length, 0)) {
            return;
        }
        if (b6U["A4"](arguments.length, 2)) {
            for (var k = 0; b6U["J4"](k, this["batch"].length); k++) {
                U["call"](E, this["batch"][k]);
            }
        } else {
            var f = [null];
            for (var k = 2; b6U["K4"](k, arguments.length); k++) {
                f["push"](arguments[k]);
            }
            for (var k = 0; b6U["h4"](k, this["batch"].length); k++) {
                f[0] = this["batch"][k];
                U["apply"](E, f);
            }
        }
    }, getParticle: function (U) {
        if (b6U["q4"](U, undefined)) {
            U = 0;
        }
        if (this["list"][U]) {
            return this["list"][U];
        ...
        var k = this["game"]["debug"];
        if (k) {
            k["start"](U + 4, E + 16, 'rgb(255, 255, 255)', 132);
            k["context"].fillStyle = 'rgba(0, 74, 128, 0.5)';
            k["context"].fillRect(U, E, 360, 70);
            var f = this["force"]["x"] + '', F = this["force"]["y"] + '';
            k["line"]('Force:', f["substr"](0, 8), F["substr"](0, 8));
            k["line"]('Scroll Speed:', this["scrollSpeed"]["x"], this["scrollSpeed"]["y"]);
            k["line"]('Alive:', 'Dead:', 'Total:');
            k["line"](this["alive"], this["dead"], this["total"]);
            k["stop"]();
        }
    }, destroy: function () {
        ...
        this["renderer"] = null;
        for (var U = b6U["g4"](this["list"].length, 1); b6U["B4"](U, 0); U--) {
            this["list"][U]["kill"]();
...
Object["defineProperty"](Phaser.ParticleStorm.Emitter.prototype, "paused", {
    get: function () {
        ...
        var E = -2097975979, k = -146731748, f = 2;
        for (var F = 1; b6U.A0I.l0I(F.toString(), F.toString().length, 6386492) !== E; F++) {
            particle.sprite.kill();
            this.bmd.setPixel32(x + 1, y + 1, r, g, b, a, false);
            sprite.animations.add(name, frames, frameRate, loop, numeric);
            f += 2;
        }
        if (b6U.A0I.l0I(f.toString(), f.toString().length, 8963448) !== k) {
...
Phaser["ParticleStorm"]["Particle"] = function (U) {
    this["emitter"] = U;
    this["renderer"] = null;
    this["graph"] = Phaser["ParticleStorm"]["Graph"];
...
Phaser.ParticleStorm.Particle.prototype = {
    reset: function (U, E, k, f) {
        ...
        this["_lastPercent"] = 0;
        this["_numToEmit"] = 0;
        if (b6U["w4"](f, undefined)) {
            this["create"](E, k, f);
        }
        return this;
    }, create: function (U, E, k) {
        if (k["hasOwnProperty"]('lifespan')) {
            this["lifespan"] = this["graph"]["getMinMax"](k["lifespan"]);
        }
        this["keepAlive"] = k["keepAlive"];
        if (k["hasOwnProperty"]('delay')) {
            this["delay"] = this["graph"]["getMinMax"](k["delay"]);
        }
        this["ignoreForce"] = k["ignoreForce"];
        this["ignoreScrollSpeed"] = k["ignoreScrollSpeed"];
        this.transform["init"](U, E, k);
        this["color"]["init"](k);
        this["texture"]["init"](k);
        if (k["emit"]) {
            this["emit"] = Object["create"](k["emit"]);
        }
        this["visible"] = (b6U["b4"](k["visible"], false)) ? false : true;
        this["alive"] = true;
        ...
        if (this["alive"]) {
            this.transform["step"]();
            this["color"]["step"]();
            var f = this["renderer"]["add"](this);
            if (f) {
                this["texture"]["step"](k, f);
            }
            this["onEmit"]();
        ...
        this["_age"] += U;
        if (this["delay"]) {
            if (b6U["u4"](this["_age"], this["delay"])) {
                this["renderer"]["update"](this);
                return true;
            } else {
                this["delay"] = 0;
        ...
        if (b6U["U2"](this["lifespan"], 0)) {
            this["life"] = Math["min"](b6U["E2"](this["_age"], this["lifespan"]), 1.0);
        }
        if (E && !this["ignoreForce"]) {
            this.transform["velocity"]["x"]["value"] += E["x"];
            this.transform["velocity"]["y"]["value"] += E["y"];
        }
        this.transform["step"]();
        this["color"]["step"]();
        this["onUpdate"]();
        if (this["alive"]) {
            this["_numToEmit"] += this["emitter"]["updateFrequency"](this["emit"], U, this["_lastPercent"], this["life"]);
            while (b6U["k2"](this["_numToEmit"], 1.0)) {
                this["emitChild"]();
            }
            this["renderer"]["update"](this);
        }
        if (!this["isComplete"] && b6U["F2"](this["life"], 1.0)) {
            this["isComplete"] = true;
            if (this["emitter"]["onComplete"]) {
                this["emitter"]["onComplete"]["dispatch"](this["emitter"], this);
            }
        }
        return (b6U["X2"](this["life"], 1.0) || this["keepAlive"]);
    }, emitChild: function () {
        var U = b6U["P2"](this["graph"]["getMinMax"](this["emit"]["offsetX"]), 0),
            E = b6U["m2"](this["graph"]["getMinMax"](this["emit"]["offsetY"]), 0);
        if (this["emit"].rect) {
            var k = this["emit"].rect;
            U = b6U["l2"](Math["random"](), k.width) + k["x"];
            E = b6U["e2"](Math["random"](), k.height) + k["y"];
        } else if (this["emit"]["circle"]) {
            var f = this["emit"]["circle"];
            E = b6U["Z2"](Math["random"]() * f * 2, f);
            var F = Math["sqrt"](b6U["t2"](f * f, E * E));
            U = b6U["D2"](Math["random"]() * F * 2, F);
        }
        var X = this["emit"]["name"];
        if (typeof X !== 'string') {
            X = this["getChildKey"](this["emit"]["name"]);
        }
        if (X) {
            var v = this["emitter"]["emitParticle"](X, this.transform["x"] + U, this.transform["y"] + E, this);
            if (v && this["emit"]["overwrite"]) {
                this["applyOverwrite"](this["emit"]["overwrite"], v);
            }
        }
        this["_numToEmit"] -= 1.0;
    }, applyOverwrite: function (U, E) {
        return E;
    }, getChildKey: function (U) {
        if (Array["isArray"](U)) {
            return this["emitter"]["game"]["rnd"]["pick"](U);
        }
        if (b6U["I2"](U["at"], undefined) && b6U["C2"](U["at"].length, 0)) {
            var E = U["at"][0]["value"];
            for (var k = 0; b6U["T2"](k, U["at"].length); k++) {
                if (b6U["N2"](U["at"][k]["time"], this["life"])) {
                    break;
                }
                E = U["at"][k]["value"];
            }
        ...
        return null;
    }, radiate: function (U, E, k) {
        if (b6U["S2"](k, undefined) && b6U["d0"](E, undefined)) {
            k = E;
        } else {
            if (b6U["p0"](E, undefined)) {
                E = 0;
            }
            if (b6U["x0"](k, undefined)) {
                k = 359;
            }
        }
        var f = U;
        if (U["hasOwnProperty"]("min")) {
            f = this["graph"]["getMinMax"](U);
        } else if (Array["isArray"](U)) {
            f = parseFloat(this["emitter"]["game"]["rnd"]["pick"](U), 10);
        }
        var F = b6U["F0"]((Math["random"]() * (k - E) + E), Math["PI"], 180.0);
        this.transform["velocity"]["x"]["value"] = b6U["X0"](Math["sin"](F), f);
        this.transform["velocity"]["y"]["value"] = -Math["cos"](F) * f;
        return this;
    }, radiateFrom: function (U, E, k) {
        var f = k;
        if (k["hasOwnProperty"]("min")) {
            f = this["graph"]["getMinMax"](k);
        } else if (Array["isArray"](k)) {
            f = parseFloat(this["emitter"]["game"]["rnd"]["pick"](k), 10);
        }
        var F = (b6U["P0"](this.transform["x"], U)), X = (b6U["m0"](this.transform["y"], E)),
            v = Math["sqrt"](b6U["l0"](F, F) + b6U["e0"](X, X));
        this.transform["velocity"]["x"]["value"] = b6U["Z0"](F, f, v);
        this.transform["velocity"]["y"]["value"] = b6U["Y0"](X, f, v);
        return this;
    }, target: function (U) {
        var E = 0, k = 0, f = this.transform;
        if (U["x"]) {
            E = U["x"];
        }
        if (U["y"]) {
        ...
        if (U["zone"]) {
            var F = U["zone"]["getRandom"]();
            E += F["x"];
            k += F["y"];
        }
        var X = Math["atan2"](b6U["g0"](k, f["y"]), b6U["B0"](E, f["x"])), v = b6U["w0"](f["x"], E),
            s = b6U["b0"](f["y"], k), o = b6U["u0"](Math["sqrt"](v * v + s * s), (this["lifespan"] / 1000)),
            R = b6U["U6"]((Math["cos"](X) * o), f["time"]["physicsElapsed"]),
            A = b6U["E6"]((Math["sin"](X) * o), f["time"]["physicsElapsed"]);
        if (U.speed) {
            this["graph"]["fromControl"]({value: b6U["k6"](R, 2), control: U.speed}, f["velocity"]["x"]);
            this["graph"]["fromControl"]({value: b6U["f6"](A, 2), control: U.speed}, f["velocity"]["y"]);
        } else {
            f["velocity"]["x"]["value"] = R;
            f["velocity"]["y"]["value"] = A;
        }
        return this;
    }, setLife: function (U, E) {
        this["lifespan"] = this["graph"]["getMinMax"](U);
        this["life"] = 0;
        this["_age"] = 0;
        this["_lastPercent"] = 0;
        this["isComplete"] = false;
...
Object["defineProperty"](Phaser.ParticleStorm.Particle.prototype, "lifePercent", {
    get: function () {
        return Math["round"](b6U["i6"](this["life"], 100));
    }
});
...
Phaser["ParticleStorm"]["GravityWell"] = function (U, E, k, f, F, X) {
    if (b6U["v6"](E, undefined)) {
        E = 0;
    }
    if (b6U["s6"](k, undefined)) {
        k = 0;
    }
    if (b6U["R6"](f, undefined)) {
        f = 0;
    }
    if (b6U["Q6"](F, undefined)) {
        F = 100;
    }
    if (b6U["c6"](X, undefined)) {
        X = 50;
    }
    this["emitter"] = U;
    this["time"] = U["game"]["time"];
    this["position"] = new Phaser["Point"](E, k);
    this["active"] = true;
    this["_gravity"] = X;
    this["_power"] = 0;
    this["_epsilon"] = 0;
...
Phaser.ParticleStorm.GravityWell.prototype = {
    step: function (U) {
        var E = b6U["j6"](this["position"]["x"], U.transform["x"]),
            k = b6U["Y6"](this["position"]["y"], U.transform["y"]), f = b6U["V6"](E, E) + b6U["G6"](k, k);
        if (b6U["r6"](f, 0)) {
            return;
        }
        var F = Math["sqrt"](f);
        if (b6U["n6"](f, this["_epsilon"])) {
            f = this["_epsilon"];
        }
        var X = b6U["H6"]((this["_power"] * this["time"]["elapsed"]), (f * F));
        U.transform["velocity"]["x"]["value"] += b6U["L6"](E, X);
        U.transform["velocity"]["y"]["value"] += b6U["z5"](k, X);
    }
};
Object["defineProperty"](Phaser.ParticleStorm.GravityWell.prototype, "epsilon", {
    get: function () {
        ...
        this["_epsilon"] = b6U["M5"](U, U);
    }
});
Object["defineProperty"](Phaser.ParticleStorm.GravityWell.prototype, "power", {
    get: function () {
        return b6U["O5"](this["_power"], this["gravity"]);
    }, set: function (U) {
        this["_power"] = b6U["W5"](U, this["gravity"]);
    }
});
...
Phaser["ParticleStorm"]["Graph"] = {
    ...
    getControlValue: function (U, E) {
        var k = 0, f = U[k];
        if (b6U["X5"](f["x"], E)) {
            return f["y"];
        }
        while (b6U["P5"](f["x"], E)) {
            if (b6U["m5"](k, U.length - 1)) {
                return f["x"];
            }
            f = U[++k];
        }
        var F = U[b6U["l5"](k, 1)];
        return F["y"] + b6U["e5"]((E - F["x"]), (f["y"] - F["y"]), (f["x"] - F["x"]));
    },
    getControlValues: function (U, E, k) {
        var f = Phaser["ParticleStorm"]["Graph"]["getControlValue"](U, E), F = [{x: E, y: f}];
        if (b6U["j5"](E, k)) {
            return F;
        }
        for (var X = 0; b6U["Y5"](X, U.length); X++) {
            if (b6U["V5"](U[X]["x"], E)) {
                if (b6U["G5"](U[X]["x"], k)) {
                    F["push"](U[X]);
                } else {
        ...
        F["push"]({x: k, y: Phaser["ParticleStorm"]["Graph"]["getControlValue"](U, k)});
        return F;
    },
    getParamArea: function (U, E, k) {
        if (U["control"]) {
            return b6U["r5"](U["value"], Phaser["ParticleStorm"]["Graph"]["getControlArea"](U["control"], E, k));
        }
        return U["value"];
    },
    getControlArea: function (U, E, k) {
        var f = Phaser["ParticleStorm"]["Graph"]["getControlValues"](U, E, k);
        if (b6U["n5"](E, k)) {
            return f[0]["y"];
        }
        var F = b6U["H5"](f.length, 1) ? 0 : f["y"], X = f[0];
        for (var v = 1; b6U["L5"](v, f.length); v++) {
            var s = f[v];
            F += b6U["z9"](0.5, (s["x"] - X["x"]), (X["y"] + s["y"]));
            X = s;
        }
        return F;
    },
    getMinMaxInitial: function (U) {
        if (b6U["k9"](U["initial"], undefined)) {
            return Phaser["ParticleStorm"]["Graph"]["getMinMax"](U["initial"]);
        } else {
            return 0;
        }
    },
    ...
    getMinMax: function (U) {
        if (b6U["f9"](U, undefined) && b6U["i9"](U, null) && b6U["v9"](U["min"], undefined) && b6U["s9"](U["max"], undefined)) {
            return U["min"] + b6U["R9"](Math["random"](), (U["max"] - U["min"]));
        }
        return U;
    },
    clone: function (U, E) {
    ...
    fromControl: function (U, E) {
        if (b6U["Q9"](U["value"], undefined)) {
            E["value"] = Phaser["ParticleStorm"]["Graph"]["getMinMax"](U["value"]);
        }
        if (U["control"]) {
            if (b6U["c9"](U["control"], 'linear')) {
                E["control"] = Phaser["ParticleStorm"]["Graph"]["CONTROL_LINEAR"];
            } else if (b6U["j9"](U["control"], 'reverse')) {
                E["control"] = Phaser["ParticleStorm"]["Graph"]["CONTROL_REVERSE"];
            } else if (b6U["Y9"](U["control"], 'yoyo')) {
                E["control"] = Phaser["ParticleStorm"]["Graph"]["CONTROL_YOYO"];
            } else {
                E["control"] = U["control"];
            }
        }
    },
    fromData: function (U, E) {
        if (b6U["V9"](U, undefined) || b6U["G9"](U, null)) {
            return false;
        }
        if (typeof U === 'number') {
            E["value"] = U;
        ...
        if (b6U["r9"](U["min"], undefined)) {
            E["value"] = Phaser["ParticleStorm"]["Graph"]["getMinMax"](U);
        } else if (b6U["n9"](U["value"], undefined)) {
            E["value"] = Phaser["ParticleStorm"]["Graph"]["getMinMax"](U["value"]);
        }
        if (b6U["H9"](U["initial"], undefined)) {
            E["initial"] = Phaser["ParticleStorm"]["Graph"]["getMinMax"](U["initial"]);
        }
        var k = -1780017002, f = 759724182, F = 2;
        for (var X = 1; b6U.A0I.l0I(X.toString(), X.toString().length, 6610236) !== k; X++) {
        ...
        if (b6U.A0I.l0I(F.toString(), F.toString().length, 3553173) !== f) {
            this.bmd.setPixel32(x + 1, y, r, g, b, a, false);
            this.stamp.destroy();
            return q9 === D9;
        }
        if (b6U["L9"](U["delta"], undefined)) {
            E["delta"] = Phaser["ParticleStorm"]["Graph"]["getMinMax"](U["delta"]);
        }
        if (b6U["z7"](U["offset"], undefined)) {
            E["offset"] = Phaser["ParticleStorm"]["Graph"]["getMinMax"](U["offset"]);
        }
        if (U["control"]) {
            if (b6U["M7"](U["control"], 'linear')) {
                E["control"] = Phaser["ParticleStorm"]["Graph"]["CONTROL_LINEAR"];
            } else if (b6U["O7"](U["control"], 'reverse')) {
                E["control"] = Phaser["ParticleStorm"]["Graph"]["CONTROL_REVERSE"];
            } else if (b6U["W7"](U["control"], 'yoyo')) {
                E["control"] = Phaser["ParticleStorm"]["Graph"]["CONTROL_YOYO"];
            } else {
                E["control"] = U["control"];
            }
    ...
    getValue: function (U, E) {
        if (!U["control"] || b6U["X7"](E, undefined)) {
            return U["value"];
        }
        var k = U["control"][0];
        if (b6U["P7"](k["x"], E)) {
        ...
        var f = b6U["m7"](U["control"].length, 1), F = U["control"][f];
        if (b6U["l7"](F["x"], E)) {
            return F["y"];
        }
        f = 0;
        while (b6U["e7"](k["x"], E)) {
            if (b6U["Z7"](f, U["control"].length - 1)) {
                return k["y"];
            }
            k = U["control"][++f];
        }
        var X = U["control"][b6U["t7"](f, 1)];
        return b6U["D7"](U["value"], (X["y"] + (E - X["x"]) * (k["y"] - X["y"]) / (k["x"] - X["x"])));
    },
    getClampedValue: function (U, E) {
        return Phaser["Math"]["clamp"](Math["floor"](U["initial"] + this["getValue"](U, E)), U["min"], U["max"]);
    }
};
Phaser["ParticleStorm"]["Zones"] = {};
Phaser["ParticleStorm"]["Zones"]["Base"] = function (U) {
    this["game"] = U;
    this["active"] = true;
...
Phaser.ParticleStorm.Zones.Base.prototype = {
    getRandom: function () {
        if (b6U["I7"](this["shape"], Phaser["Point"])) {
        ...
        return this["_rnd"];
    }, emit: function (U, E, k, f, F) {
        if (Array["isArray"](k)) {
            k = this["game"]["rnd"]["between"](k[0], k[1]);
        }
        if (Array["isArray"](f)) {
            f = this["game"]["rnd"]["between"](f[0], f[1]);
        }
        var X = null;
        for (var v = 0; b6U["C7"](v, F); v++) {
            this["shape"]["random"](this["_rnd"]);
            X = U["emitParticle"](E, k + (b6U["T7"](this["_rnd"]["x"], this.scale["x"])), f + (b6U["N7"](this["_rnd"]["y"], this.scale["y"])), null);
        }
        return X;
    }
};
Phaser.ParticleStorm.Zones.Base.prototype.constructor = Phaser["ParticleStorm"]["Zones"]["Base"];
Phaser["ParticleStorm"]["Zones"]["Point"] = function (U, E, k) {
    Phaser["ParticleStorm"]["Zones"]["Base"]["call"](this, U);
    this["shape"] = new Phaser["Point"](E, k);
};
...
Phaser["ParticleStorm"]["Zones"]["Rectangle"] = function (U, E, k) {
    Phaser["ParticleStorm"]["Zones"]["Base"]["call"](this, U);
    this["shape"] = new Phaser["Rectangle"](0, 0, E, k);
};
...
Phaser["ParticleStorm"]["Zones"]["Circle"] = function (U, E) {
    Phaser["ParticleStorm"]["Zones"]["Base"]["call"](this, U);
    this["shape"] = new Phaser["Circle"](0, 0, b6U["S7"](E, 2));
};
...
Phaser["ParticleStorm"]["Zones"]["Ellipse"] = function (U, E, k) {
    Phaser["ParticleStorm"]["Zones"]["Base"]["call"](this, U);
    this["shape"] = new Phaser["Ellipse"](0, 0, E, k);
};
...
Phaser["ParticleStorm"]["Zones"]["Line"] = function (U, E, k, f, F) {
    Phaser["ParticleStorm"]["Zones"]["Base"]["call"](this, U);
    this["shape"] = new Phaser["Line"](E, k, f, F);
};
...
Phaser["ParticleStorm"]["Zones"]["Spline"] = function (U, E, k, f, F) {
    if (b6U["d1"](E, undefined)) {
        E = 0;
    }
    if (b6U["p1"](k, undefined)) {
        k = 1000;
    }
    if (b6U["O1"](f, undefined)) {
        f = true;
    }
    Phaser["ParticleStorm"]["Zones"]["Base"]["call"](this, U);
...
Phaser.ParticleStorm.Zones.Spline.prototype.update = function (U) {
    this["points"] = {x: [], y: []};
    this["path"] = [];
    for (var E = 0; b6U["W1"](E, U.length); E++) {
        this["points"]["x"]["push"](U[E]["x"]);
        this["points"]["y"]["push"](U[E]["y"]);
    }
    if (this["closed"]) {
        this["points"]["x"]["push"](U[0]["x"]);
        this["points"]["y"]["push"](U[0]["y"]);
    }
    var k = 0, f = b6U["v1"](1, this["resolution"]);
    for (var E = 0; b6U["s1"](E, 1); E += f) {
        if (b6U["R1"](this["mode"], 0)) {
            var F = this["math"]["linearInterpolation"](this["points"]["x"], E),
                X = this["math"]["linearInterpolation"](this["points"]["y"], E);
        } else if (b6U["Q1"](this["mode"], 1)) {
            var F = this["math"]["bezierInterpolation"](this["points"]["x"], E),
                X = this["math"]["bezierInterpolation"](this["points"]["y"], E);
        } else if (b6U["c1"](this["mode"], 2)) {
            var F = this["math"]["catmullRomInterpolation"](this["points"]["x"], E),
                X = this["math"]["catmullRomInterpolation"](this["points"]["y"], E);
        }
        var v = {x: F, y: X, angle: 0};
        if (b6U["j1"](k, 0)) {
            v["angle"] = this["math"]["angleBetweenPoints"](this["path"][b6U["Y1"](k, 1)], v);
        }
        this["path"]["push"](v);
        k++;
    }
    this["mult"] = b6U["V1"](this["path"].length, 100);
    return this;
};
Phaser.ParticleStorm.Zones.Spline.prototype.getRandom = function () {
    return this["game"]["rnd"]["pick"](this["path"]);
};
Phaser.ParticleStorm.Zones.Spline.prototype.emit = function (U, E, k, f, F) {
    if (Array["isArray"](k)) {
        k = this["game"]["rnd"]["between"](k[0], k[1]);
    }
    if (Array["isArray"](f)) {
    ...
    var X = null, v = null;
    for (var s = 0; b6U["G1"](s, F); s++) {
        X = this["game"]["rnd"]["pick"](this["path"]);
        v = U["emitParticle"](E, k + X["x"], f + X["y"]);
    }
    return v;
};
Phaser.ParticleStorm.Zones.Spline.prototype.emitPercent = function (U, E, k, f, F, X) {
    if (Array["isArray"](k)) {
        k = this["game"]["rnd"]["between"](k[0], k[1]);
    }
    if (Array["isArray"](f)) {
    ...
    var v = null;
    X = Math["floor"](b6U["r1"](X, this["mult"]));
    for (var s = 0; b6U["n1"](s, F); s++) {
        var o = this["path"][X];
        if (o) {
            v = U["emitParticle"](E, k + o["x"], f + o["y"]);
        }
    }
    return v;
};
Phaser["ParticleStorm"]["Zones"]["Text"] = function (U, E) {
    Phaser["ParticleStorm"]["Zones"]["Base"]["call"](this, U);
    this["bmd"] = new Phaser["BitmapData"](U, 'ParticleStorm.Text');
    this["text"] = E;
    this["points"] = [];
    this["update"](E);
};
...
Phaser.ParticleStorm.Zones.Text.prototype.update = function (U) {
    if (b6U["H1"](U, undefined)) {
        this["text"] = U;
    } else {
        U = this["text"];
    }
    var E = U["x"], k = U["y"], f = U.scale["x"], F = U.scale["y"];
    U["x"] = 0;
    U["y"] = 0;
    U.scale["set"](1);
    this["points"] = [];
    this["bmd"].load(U);
    this["bmd"]["processPixelRGB"](this["addPixel"], this);
    this.scale = new Phaser["Point"](f, F);
    U["x"] = E;
    U["y"] = k;
    U.scale["set"](f, F);
    return this;
};
Phaser.ParticleStorm.Zones.Text.prototype.addPixel = function (U, E, k) {
    if (b6U["L1"](U["a"], this["alphaThreshold"])) {
        this["points"]["push"]({x: E, y: k, color: {r: U["r"], g: U["g"], b: U["b"], a: b6U["z8I"](U["a"], 255)}});
    }
    return false;
};
Phaser.ParticleStorm.Zones.Text.prototype.getRandom = function () {
    var U = this["game"]["rnd"]["pick"](this["points"]);
    U["x"] *= this.scale["x"];
    U["y"] *= this.scale["y"];
    return U;
};
Phaser.ParticleStorm.Zones.Text.prototype.emit = function (U, E, k, f, F, X, v) {
    if (Array["isArray"](k)) {
        k = this["game"]["rnd"]["between"](k[0], k[1]);
    }
    if (Array["isArray"](f)) {
    ...
    var s = null, o = null;
    for (var R = 0; b6U["M8I"](R, F); R++) {
        s = this["game"]["rnd"]["pick"](this["points"]);
        o = U["emitParticle"](E, k + (b6U["O8I"](s["x"], this.scale["x"])), f + (b6U["W8I"](s["y"], this.scale["y"])));
        if (o) {
            if (X && b6U["X8I"](s["color"]["a"], 1)) {
                o["color"]["alpha"]["value"] = s["color"]["a"];
            }
            if (v) {
                o["color"]["setColor"](s["color"]["r"], s["color"]["g"], s["color"]["b"], s["color"]["a"]);
            }
        }
    }
    return o;
};
Phaser.ParticleStorm.Zones.Text.prototype.emitFull = function (U, E, k, f, F, X, v, s) {
    if (b6U["P8I"](F, undefined)) {
        F = 1;
    }
    var o = 1, R = 1;
    if (Array["isArray"](X)) {
    ...
    var A = null, Q = null;
    for (var J = 0; b6U["m8I"](J, this["points"].length); J += F) {
        A = this["points"][J];
        var c = k + b6U["l8I"]((A["x"] * this.scale["x"]), (o / F)),
            K = f + b6U["e8I"]((A["y"] * this.scale["y"]), (R / F));
        Q = U["emitParticle"](E, c, K);
        if (Q) {
            if (v && b6U["Z8I"](A["color"]["a"], 1)) {
                Q["color"]["alpha"]["value"] = A["color"]["a"];
            }
            if (s) {
                Q["color"]["setColor"](A["color"]["r"], A["color"]["g"], A["color"]["b"], A["color"]["a"]);
            }
        }
    }
    return Q;
};
Phaser["ParticleStorm"]["Zones"]["Image"] = function (U, E) {
    Phaser["ParticleStorm"]["Zones"]["Base"]["call"](this, U);
    this["bmd"] = new Phaser["BitmapData"](U, 'ParticleStorm.Image');
    this["key"] = E;
    this["points"] = [];
    this["update"](E);
};
...
Phaser.ParticleStorm.Zones.Image.prototype.update = function (U) {
    if (b6U["t8I"](U, undefined)) {
        U = this["key"];
    }
    this["points"] = [];
    this["bmd"].load(U);
...
Phaser.ParticleStorm.Zones.Image.prototype.addPixel = function (U, E, k) {
    if (b6U["D8I"](U["a"], this["alphaThreshold"])) {
        this["points"]["push"]({x: E, y: k, color: {r: U["r"], g: U["g"], b: U["b"], a: b6U["I8I"](U["a"], 255)}});
    }
    return false;
};
...
Phaser.ParticleStorm.Zones.Image.prototype.emit = function (U, E, k, f, F, X, v) {
    if (Array["isArray"](k)) {
        k = this["game"]["rnd"]["between"](k[0], k[1]);
    }
    if (Array["isArray"](f)) {
    ...
    var s = null, o = null;
    for (var R = 0; b6U["C8I"](R, F); R++) {
        s = this["game"]["rnd"]["pick"](this["points"]);
        o = U["emitParticle"](E, k + (b6U["T8I"](s["x"], this.scale["x"])), f + (b6U["N8I"](s["y"], this.scale["y"])));
        if (o) {
            if (X && b6U["S8I"](s["color"]["a"], 1)) {
                o["color"]["alpha"]["value"] = s["color"]["a"];
            }
            if (v) {
                o["color"]["setColor"](s["color"]["r"], s["color"]["g"], s["color"]["b"], s["color"]["a"]);
...
Phaser.ParticleStorm.Zones.Image.prototype.emitFull = function (U, E, k, f, F, X, v, s) {
    if (b6U["d3I"](F, undefined)) {
        F = 1;
    }
    var o = 1, R = 1;
    if (Array["isArray"](X)) {
    ...
    var A = null, Q = null;
    for (var J = 0; b6U["p3I"](J, this["points"].length); J += F) {
        A = this["points"][J];
        var c = k + b6U["x3I"]((A["x"] * this.scale["x"]), (o / F)),
            K = f + b6U["F3I"]((A["y"] * this.scale["y"]), (R / F));
        Q = U["emitParticle"](E, c, K);
        if (Q) {
            if (v && b6U["y3I"](A["color"]["a"], 1)) {
                Q["color"]["alpha"]["value"] = A["color"]["a"];
            }
            if (s) {
                Q["color"]["setColor"](A["color"]["r"], A["color"]["g"], A["color"]["b"], A["color"]["a"]);
...
Phaser["ParticleStorm"]["Controls"]["Texture"] = function (U) {
    this["particle"] = U;
    this["rnd"] = U["emitter"]["game"]["rnd"];
    this["graph"] = Phaser["ParticleStorm"]["Graph"];
...
Phaser.ParticleStorm.Controls.Texture.prototype = {
    reset: function () {
        ...
        if (U["sendToBack"]) {
            this["sendToBack"] = U["sendToBack"];
        } else if (U["bringToTop"]) {
            this["bringToTop"] = U["bringToTop"];
        }
        if (U["image"]) {
            if (Array["isArray"](U["image"])) {
                this["key"] = this["rnd"]["pick"](U["image"]);
            } else {
                this["key"] = U["image"];
            }
        }
        if (b6U["o3I"](U["frame"], undefined)) {
            var E = U["frame"];
            if (Array["isArray"](U["frame"])) {
                E = this["rnd"]["pick"](U["frame"]);
            }
            if (this["graph"]["isNumeric"](E)) {
                this["frame"] = E;
            } else {
                this["frameName"] = E;
            }
        ...
        if (U["scaleMode"]) {
            var k = U["scaleMode"]["toUpperCase"]();
            if (b6U["a3I"](k, 'LINEAR')) {
                this["scaleMode"] = Phaser["scaleModes"]["LINEAR"];
            } else if (b6U["A3I"](k, 'NEAREST')) {
                this["scaleMode"] = Phaser["scaleModes"]["NEAREST"];
            }
        }
    }, step: function (U, E) {
        if (b6U["J3I"](this["particle"]["emitter"]["renderType"], Phaser["ParticleStorm"]["SPRITE"]) && b6U["K3I"](U["animations"], undefined)) {
            var k = [];
            for (var f in U["animations"]) {
                var F = U["animations"][f], X = null, v = true;
                if (b6U["h3I"](F["frames"], undefined)) {
                    if (Array["isArray"](F["frames"])) {
                        X = F["frames"];
                    } else {
                        X = Phaser["Animation"]["generateFrameNames"](F["frames"]["prefix"], F["frames"]["start"], F["frames"]["stop"], F["frames"]["suffix"], F["frames"]["zeroPad"]);
                    }
                    if (typeof X[0] === 'string') {
                        v = false;
                    }
                }
                var s = (b6U["q3I"](F["frameRate"], undefined)) ? 60 : F["frameRate"],
                    o = (b6U["g3I"](F["loop"], undefined)) ? false : F["loop"];
                E["animations"]["add"](f, X, s, o, v);
                k["push"](f);
            }
            if (b6U["B3I"](k.length, 0)) {
                if (b6U["w3I"](U.play, undefined)) {
                    E.play(this["rnd"]["pick"](k));
                } else {
                    E.play(k[0]);
                }
            }
...
Phaser["ParticleStorm"]["Controls"]["Color"] = function (U) {
    this["particle"] = U;
    this["graph"] = Phaser["ParticleStorm"]["Graph"];
    this["red"] = {};
    this["green"] = {};
...
Phaser.ParticleStorm.Controls.Color.prototype = {
    reset: function () {
        ...
        var E = false;
        if (U["hasOwnProperty"]('hsv')) {
            if (typeof U["hsv"] === 'number') {
                this["hsv"]["value"] = U["hsv"];
            } else {
                this["graph"]["fromData"](U["hsv"], this["hsv"]);
            }
            E = true;
            this["isHSV"] = true;
        } else {
            if (U["hasOwnProperty"]('red')) {
                if (typeof U["red"] === 'number') {
                    this["red"]["value"] = U["red"];
                } else {
                    this["graph"]["fromData"](U["red"], this["red"]);
                }
                E = true;
            }
            if (U["hasOwnProperty"]('green')) {
                if (typeof U["green"] === 'number') {
                    this["green"]["value"] = U["green"];
                } else {
                    this["graph"]["fromData"](U["green"], this["green"]);
                }
                E = true;
            }
            if (U["hasOwnProperty"]('blue')) {
                if (typeof U["blue"] === 'number') {
                    this["blue"]["value"] = U["blue"];
                } else {
                    this["graph"]["fromData"](U["blue"], this["blue"]);
                }
                E = true;
            }
        }
        if (U["hasOwnProperty"]('alpha')) {
            if (typeof U["alpha"] === 'number') {
                this["alpha"]["value"] = U["alpha"];
            } else {
                this["graph"]["fromData"](U["alpha"], this["alpha"]);
            }
        }
        ...
        if (b6U["b3I"](this["particle"]["emitter"]["renderType"], Phaser["ParticleStorm"]["PIXEL"])) {
            this["isTinted"] = E;
        }
        if (U["blendMode"]) {
            this["blendMode"] = this.particle.emitter.parent.blendModeMap[U["blendMode"]["toUpperCase"]()];
        }
    }, step: function () {
        var U = this["particle"]["life"];
        if (this["isHSV"]) {
            this["hsv"]["value"] += this["hsv"]["delta"];
            this["hsv"]["calc"] = Phaser["Math"]["clamp"](Math["floor"](this["hsv"]["initial"] + this["graph"]["getValue"](this["hsv"], U)), 0, 359);
        ...
        this["red"]["calc"] = this["graph"]["getClampedValue"](this["red"], U);
        this["green"]["calc"] = this["graph"]["getClampedValue"](this["green"], U);
        this["blue"]["calc"] = this["graph"]["getClampedValue"](this["blue"], U);
        if (this["isTinted"]) {
            this["tint"] = b6U["u3I"](this["red"]["calc"] << 16, this["green"]["calc"] << 8, this["blue"]["calc"]);
        }
        this["alpha"]["value"] += this["alpha"]["delta"];
        this["alpha"]["calc"] = Phaser["Math"]["clamp"](this["alpha"]["initial"] + this["graph"]["getValue"](this["alpha"], U), 0, 1);
        this["rgba"] = 'rgba(' + this["red"]["calc"] + ',' + this["green"]["calc"] + ',' + this["blue"]["calc"] + ',' + this["alpha"]["calc"] + ')';
    }, setColor: function (U, E, k, f) {
        this["red"]["value"] = U;
        this["green"]["value"] = E;
        this["blue"]["value"] = k;
        this["alpha"]["value"] = f;
        if (b6U["d4I"](this["particle"]["emitter"]["renderType"], Phaser["ParticleStorm"]["PIXEL"])) {
            this["isTinted"] = true;
        }
        this["step"]();
    }
...
Phaser["ParticleStorm"]["Controls"]["Transform"] = function (U) {
    this["particle"] = U;
    this["time"] = U["emitter"]["game"]["time"];
    this["graph"] = Phaser["ParticleStorm"]["Graph"];
    this["x"] = 0;
    this["y"] = 0;
...
Phaser.ParticleStorm.Controls.Transform.prototype = {
    reset: function () {
        ...
        this["x"] = U;
        var f = 1653202235, F = -947328217, X = 2;
        for (var v = 1; b6U.A0I.l0I(v.toString(), v.toString().length, 9950273) !== f; v++) {
            this.points.x.push(points[i].x);
            this.step();
            particle.sprite.kill();
            X += 2;
        }
        if (b6U.A0I.l0I(X.toString(), X.toString().length, 6434601) !== F) {
            this.texture.reset();
            particle.sprite.kill();
            this.bmd.resize(width, height);
            return this.list.length;
        ...
        this["y"] = E;
        if (k["hasOwnProperty"]('anchor')) {
            this["anchor"]["set"](k["anchor"]);
        } else {
            if (k["hasOwnProperty"]('anchorX')) {
                this["anchor"]["x"] = k["anchorX"];
            }
            if (k["hasOwnProperty"]('anchorY')) {
                this["anchor"]["y"] = k["anchorY"];
            }
        }
        if (k["hasOwnProperty"]('velocity')) {
            if (this["graph"]["isNumeric"](k["velocity"])) {
                this["velocity"]["x"]["value"] = k["velocity"];
                this["velocity"]["y"]["value"] = k["velocity"];
            } else if (k["velocity"]["hasOwnProperty"]('min')) {
                this["velocity"]["x"]["value"] = this["graph"]["getMinMax"](k["velocity"]);
                this["velocity"]["y"]["value"] = this["velocity"]["x"]["value"];
            } else if (k["velocity"]["radial"]) {
                var s = this["graph"]["getMinMaxInitial"](k["velocity"]), o = k["velocity"]["radial"]["arcStart"],
                    R = k["velocity"]["radial"]["arcEnd"];
                if (b6U["p4I"](o, undefined) && b6U["x4I"](R, undefined)) {
                    var A = b6U["F4I"]((Math["random"]() * (R - o) + o), Math["PI"], 180.0), Q = Math["sin"](A),
                        J = -Math["cos"](A);
                    this["velocity"]["x"]["value"] = b6U["X4I"](Q, s);
                    this["velocity"]["y"]["value"] = b6U["P4I"](J, s);
                }
            } else {
                this["velocity"]["x"]["initial"] = this["graph"]["getMinMaxInitial"](k["velocity"]);
                this["velocity"]["y"]["initial"] = this["velocity"]["x"]["initial"];
                this["velocity"]["x"]["value"] = this["graph"]["getMinMax"](k["velocity"]["value"]);
                this["velocity"]["y"]["value"] = this["velocity"]["x"]["value"];
            }
            if (k["velocity"]["hasOwnProperty"]('delta')) {
                this["velocity"]["x"]["delta"] = this["graph"]["getMinMax"](k["velocity"]["delta"]);
                this["velocity"]["y"]["delta"] = this["velocity"]["x"]["delta"];
            }
            if (k["velocity"]["hasOwnProperty"]('control')) {
                this["velocity"]["x"]["control"] = k["velocity"]["control"];
                this["velocity"]["y"]["control"] = k["velocity"]["control"];
            }
            if (k["hasOwnProperty"]('vx')) {
                this["graph"]["fromData"](k["vx"], this["velocity"]["x"]);
            }
            if (k["hasOwnProperty"]('vy')) {
                this["graph"]["fromData"](k["vy"], this["velocity"]["y"]);
            }
        } else if (k["hasOwnProperty"]('target')) {
            this["particle"]["target"](k["target"]);
        } else {
            if (typeof k["vx"] === 'number') {
                this["velocity"]["x"]["value"] = k["vx"];
            } else {
                this["graph"]["fromData"](k["vx"], this["velocity"]["x"]);
            }
            if (typeof k["vy"] === 'number') {
                this["velocity"]["y"]["value"] = k["vy"];
            } else {
                this["graph"]["fromData"](k["vy"], this["velocity"]["y"]);
            }
        }
        if (typeof k["facingVelocity"] === 'number') {
            this["velocity"]["facing"]["value"] = k["facingVelocity"];
        } else {
            this["graph"]["fromData"](k["facingVelocity"], this["velocity"]["facing"]);
        }
        if (typeof k["facingAcceleration"] === 'number') {
            this["acceleration"]["facing"]["value"] = k["facingAcceleration"];
        } else {
            this["graph"]["fromData"](k["facingAcceleration"], this["acceleration"]["facing"]);
        }
        if (k["hasOwnProperty"]('acceleration')) {
            this["graph"]["fromData"](k["acceleration"], this["acceleration"]["x"]);
            this["graph"]["fromData"](k["acceleration"], this["acceleration"]["y"]);
        } else {
            if (typeof k["ax"] === 'number') {
                this["acceleration"]["x"]["value"] = k["ax"];
            } else {
                this["graph"]["fromData"](k["ax"], this["acceleration"]["x"]);
            }
            if (typeof k["ay"] === 'number') {
                this["acceleration"]["y"]["value"] = k["ay"];
            } else {
                this["graph"]["fromData"](k["ay"], this["acceleration"]["y"]);
            }
        }
        if (k["hasOwnProperty"]('scale')) {
            this["graph"]["fromData"](k.scale, this.scale["x"]);
            this["graph"]["clone"](this.scale["x"], this.scale["y"]);
        } else {
            if (typeof k["scaleX"] === 'number') {
                this.scale["x"]["value"] = k["scaleX"];
            } else {
                this["graph"]["fromData"](k["scaleX"], this.scale["x"]);
            }
            if (typeof k["scaleY"] === 'number') {
                this.scale["y"]["value"] = k["scaleY"];
            } else {
                this["graph"]["fromData"](k["scaleY"], this.scale["y"]);
            }
        }
        if (typeof k["rotation"] === 'number') {
            this["rotation"]["value"] = k["rotation"];
        } else {
            this["graph"]["fromData"](k["rotation"], this["rotation"]);
        }
        var c = this.particle.parent;
        if (c && c["emit"] && c["emit"]["inherit"]) {
            this["inherit"](c);
        }
    }, inherit: function (U) {
        var E = U["emit"]["inherit"], k = false;
        if (typeof E === 'boolean') {
            k = true;
        }
        if (k || E["vx"] || E["velocity"]) {
            this["graph"]["clone"](U.transform["velocity"]["x"], this["velocity"]["x"]);
        }
        if (k || E["vy"] || E["velocity"]) {
            this["graph"]["clone"](U.transform["velocity"]["y"], this["velocity"]["y"]);
        }
        if (k || E["facingVelocity"]) {
            this["graph"]["clone"](U.transform["velocity"]["facing"], this["velocity"]["facing"]);
        }
        if (k || E["scaleX"] || E.scale) {
            this["graph"]["clone"](U.transform.scale["x"], this.scale["x"]);
        }
        if (k || E["scaleY"] || E.scale) {
            this["graph"]["clone"](U.transform.scale["y"], this.scale["y"]);
        }
        if (k || E["rotation"]) {
            this["graph"]["clone"](U.transform["rotation"], this["rotation"]);
        }
        if (E["angularVelocity"]) {
            var f = b6U["m4I"]((U.transform["rotation"]["initial"] + U.transform["rotation"]["value"]), Math["PI"], 180);
            this["velocity"]["x"]["initial"] = Math["sin"](f);
            this["velocity"]["y"]["initial"] = -Math["cos"](f);
        }
    }, step: function () {
        var U = this["particle"]["life"];
        ...
        this["rotation"]["calc"] = b6U["Q4I"]((this["rotation"]["initial"] + this["graph"]["getValue"](this["rotation"], U)), Math["PI"], 180);
        this.scale["x"]["calc"] = this.scale["x"]["initial"] + this["graph"]["getValue"](this.scale["x"], U);
        this.scale["y"]["calc"] = this.scale["y"]["initial"] + this["graph"]["getValue"](this.scale["y"], U);
        if (b6U["K4I"](U, 0)) {
            return;
        }
        var E = 0, k = 0;
        if (b6U["h4I"](this["acceleration"]["facing"]["value"], null)) {
            this["acceleration"]["facing"]["value"] += this["acceleration"]["facing"]["delta"];
            E = this["rotation"]["calc"] + (b6U["q4I"]((90 + this["acceleration"]["facing"]["offset"]), Math["PI"], 180));
            k = this["acceleration"]["facing"]["initial"] + this["graph"]["getValue"](this["acceleration"]["facing"], U);
            this["velocity"]["x"]["value"] += b6U["I4I"](k, Math["sin"](E));
            this["velocity"]["y"]["value"] += k * -Math["cos"](E);
        }
        this["acceleration"]["x"]["value"] += this["acceleration"]["x"]["delta"];
        this["acceleration"]["y"]["value"] += this["acceleration"]["y"]["delta"];
        this["velocity"]["x"]["value"] += this["velocity"]["x"]["delta"] + this["acceleration"]["x"]["initial"] + this["graph"]["getValue"](this["acceleration"]["x"], U);
        this["velocity"]["y"]["value"] += this["velocity"]["y"]["delta"] + this["acceleration"]["y"]["initial"] + this["graph"]["getValue"](this["acceleration"]["y"], U);
        if (b6U["C4I"](this["velocity"]["facing"]["value"], null)) {
            this["velocity"]["facing"]["value"] += this["velocity"]["facing"]["delta"];
            E = this["rotation"]["calc"] + (b6U["T4I"]((90 + this["velocity"]["facing"]["offset"]), Math["PI"], 180));
            k = this["velocity"]["facing"]["initial"] + this["graph"]["getValue"](this["velocity"]["facing"], U);
            this["x"] += b6U["H4I"](k, Math["sin"](E));
            this["y"] += k * -Math["cos"](E);
        }
        this["x"] += this["velocity"]["x"]["initial"] + this["graph"]["getValue"](this["velocity"]["x"], U);
        this["y"] += this["velocity"]["y"]["initial"] + this["graph"]["getValue"](this["velocity"]["y"], U);
    }
};
...
Phaser["ParticleStorm"]["Renderer"]["Base"] = function (U) {
    this["game"] = U["game"];
    this["emitter"] = U;
...
Phaser["ParticleStorm"]["Renderer"]["Sprite"] = function (U) {
    Phaser["ParticleStorm"]["Renderer"]["Base"]["call"](this, U);
...
Phaser.ParticleStorm.Renderer.Sprite.prototype.add = function (U) {
    var E = U["sprite"], k = U["texture"]["key"], f = U["texture"]["frame"];
    if (b6U["L4I"](f, undefined) && b6U["z2I"](U["texture"]["frameName"], undefined)) {
        f = U["texture"]["frameName"];
    }
    if (E) {
        E["reset"](U.transform["x"], U.transform["y"]);
        if (b6U["M2I"](E["key"], k)) {
            E["loadTexture"](k, f);
        } else {
            if (b6U["O2I"](U["texture"]["frame"], undefined)) {
                E["frame"] = f;
            } else if (b6U["W2I"](U["texture"]["frameName"], undefined)) {
                E["frameName"] = f;
            }
        }
    } else {
        E = this["display"]["create"](U.transform["x"], U.transform["y"], k, f);
    }
    E["anchor"]["set"](U.transform["anchor"]["x"], U.transform["anchor"]["y"]);
    if (U["color"]["isTinted"]) {
        E["tint"] = U["color"]["tint"];
    }
    E["blendMode"] = U["color"]["blendMode"][0];
    E["texture"]["baseTexture"]["scaleMode"] = U["texture"]["scaleMode"];
    E["visible"] = U["visible"];
    U["sprite"] = E;
    return E;
};
Phaser.ParticleStorm.Renderer.Sprite.prototype.update = function (U) {
    var E = U["sprite"];
    if (b6U["X2I"](U["delay"], 0) && !U["delayVisible"]) {
        E["visible"] = false;
        return;
    }
    E["visible"] = U["visible"];
    E["alpha"] = U["color"]["alpha"]["calc"];
    E["rotation"] = U.transform["rotation"]["calc"];
    if (U["color"]["isTinted"]) {
        E["tint"] = U["color"]["tint"];
    }
    E.scale["setTo"](U.transform.scale["x"]["calc"], U.transform.scale["y"]["calc"]);
    E["x"] = U.transform["x"];
    E["y"] = U.transform["y"];
};
Phaser.ParticleStorm.Renderer.Sprite.prototype.kill = function (U) {
    if (U["sprite"]) {
        U["sprite"]["kill"]();
    }
};
...
Phaser["ParticleStorm"]["Renderer"]["Pixel"] = function (U, E, k) {
    Phaser["ParticleStorm"]["Renderer"]["Base"]["call"](this, U);
    this["bmd"] = this["game"]["make"]["bitmapData"](E, k);
...
Phaser.ParticleStorm.Renderer.Pixel.prototype.resize = function (U, E) {
    this["bmd"]["resize"](U, E);
    return this;
};
Phaser.ParticleStorm.Renderer.Pixel.prototype.clear = function (U) {
    this["bmd"].fill(0, 0, 0, U);
    this["bmd"]["update"]();
    return this;
};
...
Phaser.ParticleStorm.Renderer.Pixel.prototype.update = function (U) {
    if (b6U["P2I"](U["delay"], 0) && !U["delayVisible"]) {
        return;
    }
    var E = Math["floor"](U.transform["x"]), k = Math["floor"](U.transform["y"]), f = U["color"]["red"]["calc"],
        F = U["color"]["green"]["calc"], X = U["color"]["blue"]["calc"],
        v = Math["floor"](b6U["m2I"](U["color"]["alpha"]["calc"], 255));
    if (b6U["l2I"](this["pixelSize"], 2)) {
        this["bmd"].rect(E, k, this["pixelSize"], this["pixelSize"], U["color"]["rgba"]);
    } else {
        this["bmd"]["setPixel32"](E, k, f, F, X, v, false);
        if (b6U["e2I"](this["pixelSize"], 2)) {
            this["bmd"]["setPixel32"](E + 1, k, f, F, X, v, false);
            this["bmd"]["setPixel32"](E, k + 1, f, F, X, v, false);
            this["bmd"]["setPixel32"](E + 1, k + 1, f, F, X, v, false);
        }
    }
};
Phaser.ParticleStorm.Renderer.Pixel.prototype.postUpdate = function () {
    if (b6U["Z2I"](this["pixelSize"], 2)) {
...
Phaser["ParticleStorm"]["Renderer"]["BitmapData"] = function (U, E, k) {
    Phaser["ParticleStorm"]["Renderer"]["Base"]["call"](this, U);
    this["bmd"] = this["game"]["make"]["bitmapData"](E, k);
    this["display"] = this["game"]["make"]["image"](0, 0, this["bmd"]);
    this["roundPx"] = true;
...
Phaser.ParticleStorm.Renderer.BitmapData.prototype.resize = function (U, E) {
    this["bmd"]["resize"](U, E);
    return this;
};
Phaser.ParticleStorm.Renderer.BitmapData.prototype.clear = function (U) {
    this["bmd"].fill(0, 0, 0, U);
    return this;
};
...
Phaser.ParticleStorm.Renderer.BitmapData.prototype.update = function (U) {
    if (b6U["t2I"](U["delay"], 0) && !U["delayVisible"]) {
        return;
    }
    var E = U.transform;
    this["bmd"]["copy"](U["texture"]["key"], 0, 0, null, null, E["x"], E["y"], null, null, E["rotation"]["calc"], E["anchor"]["x"], E["anchor"]["y"], E.scale["x"]["calc"], E.scale["y"]["calc"], U["color"]["alpha"]["calc"], U["color"]["blendMode"][1], this["roundPx"]);
};
...
Phaser["ParticleStorm"]["Renderer"]["RenderTexture"] = function (U, E, k) {
    Phaser["ParticleStorm"]["Renderer"]["Base"]["call"](this, U);
    this["renderTexture"] = this["game"]["make"]["renderTexture"](E, k);
...
Phaser.ParticleStorm.Renderer.RenderTexture.prototype.clear = function () {
    var U = 1196281202, E = -1259349577, k = 2;
    for (var f = 1; b6U.A0I.l0I(f.toString(), f.toString().length, 6996414) !== U; f++) {
        this.graph.fromControl({value: b6U.k6(vx, 2), control: data.speed}, t.velocity.x);
    ...
    if (b6U.A0I.l0I(k.toString(), k.toString().length, 8870901) !== E) {
...
Phaser.ParticleStorm.Renderer.RenderTexture.prototype.update = function (U) {
    if ((b6U["D2I"](U["delay"], 0) && !U["delayVisible"]) || !U["visible"] || b6U["I2I"](U["color"]["alpha"]["calc"], 0)) {
        return;
    }
    var E = U["texture"]["key"], k = U["texture"]["frame"];
    if (b6U["C2I"](k, undefined) && b6U["T2I"](U["texture"]["frameName"], undefined)) {
        k = U["texture"]["frameName"];
    }
    if (b6U["N2I"](this["stamp"]["key"], E)) {
        this["stamp"]["loadTexture"](E, k);
    } else {
        if (b6U["S2I"](U["texture"]["frame"], undefined)) {
            this["stamp"]["frame"] = k;
        } else if (b6U["d0I"](U["texture"]["frameName"], undefined)) {
            this["stamp"]["frameName"] = k;
        }
    }
    this["stamp"]["anchor"]["set"](U.transform["anchor"]["x"], U.transform["anchor"]["y"]);
    this["stamp"]["alpha"] = U["color"]["alpha"]["calc"];
    this["stamp"]["rotation"] = U.transform["rotation"]["calc"];
    if (U["color"]["isTinted"]) {
        this["stamp"]["tint"] = U["color"]["tint"];
    }
    this["stamp"]["blendMode"] = U["color"]["blendMode"][0];
    this["stamp"]["texture"]["baseTexture"]["scaleMode"] = U["texture"]["scaleMode"];
    this["stamp"].scale["setTo"](U.transform.scale["x"]["calc"], U.transform.scale["y"]["calc"]);
    this["renderTexture"]["renderXY"](this["stamp"], U.transform["x"], U.transform["y"], false);
};
...
Phaser["ParticleStorm"]["Renderer"]["SpriteBatch"] = function (U) {
    Phaser["ParticleStorm"]["Renderer"]["Base"]["call"](this, U);
...
Phaser.ParticleStorm.Renderer.SpriteBatch.prototype.add = function (U) {
    var E = U["sprite"], k = U["texture"]["key"], f = U["texture"]["frame"];
    if (b6U["p0I"](f, undefined) && b6U["x0I"](U["texture"]["frameName"], undefined)) {
        f = U["texture"]["frameName"];
    }
    if (E) {
        E["reset"](U.transform["x"], U.transform["y"]);
        if (b6U["F0I"](E["key"], k)) {
            ...
            if (b6U["y0I"](U["texture"]["frame"], undefined)) {
                E["frame"] = f;
            } else if (b6U["o0I"](U["texture"]["frameName"], undefined)) {
                E["frameName"] = f;
            }
        }
    } else {
        E = this["game"]["make"]["sprite"](U.transform["x"], U.transform["y"], k, f);
    }
...
Phaser.ParticleStorm.Renderer.SpriteBatch.prototype.update = function (U) {
    var E = U["sprite"];
    if (b6U["a0I"](U["delay"], 0) && !U["delayVisible"]) {
        E["visible"] = false;
        return;
    }
    E["visible"] = U["visible"];
...
Phaser.ParticleStorm.Renderer.SpriteBatch.prototype.kill = function (U) {
    if (U["sprite"]) {
        U["sprite"]["kill"]();
    }
};
